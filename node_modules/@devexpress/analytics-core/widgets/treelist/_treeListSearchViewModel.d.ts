...
export declare class TreeListSearchViewModel extends Disposable {
    static createController(element: Element, controllers: ITreeListController[], modelType?: typeof TreeListSearchViewModel, templateName?: string): TreeListSearchViewModel;
