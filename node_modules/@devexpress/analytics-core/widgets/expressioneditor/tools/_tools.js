...
export class Tools extends Disposable {
    ...
    _createFunctionsCategoryItem(functions, display) {
        ...
        result.data.sort((a, b) => this._compareFunctionItems(a, b));
        return result;
    }
    _compareFunctionItems(item1, item2) {
        const text1 = item1.displayName || item1.text;
        const text2 = item2.displayName || item2.text;
