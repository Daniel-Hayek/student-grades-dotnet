...
export class FilterEditorHelper {
    ...
    registrateOperator(specific, targetEnum, value, name, operatorType = 'function', reverse = false, localizationId, insertVal) {
        if (this.filterEditorOperators[specific]) {
            ...
            const newOperator = { name: name, value: targetEnum[value], insertVal, type: targetEnum, _type: operatorType, reverse, emptyRightPart: true, displayText: getLocalization(name, localizationId) };
...
FilterEditorHelper._customExpressions = [];
FilterEditorHelper.addCustomExpression = (customExpression) => {
    customExpression && FilterEditorHelper._customExpressions.push(customExpression);
};
