...
import { CriteriaEditorBase, ICriteriaEditorContext } from '../../core/widgets/_criteriaPopupEditorBase';
import { AIExpressionGenerator } from '../expressioneditor/aiExpressionGenerator';
...
export declare class FilterEditor extends CriteriaEditorBase {
    ...
    aiFilterGenerator: AIExpressionGenerator;
    dispose(): void;
    ...
    getEditorContext(): ICriteriaEditorContext;
