...
import { TreeListSearchViewModel } from '../../widgets/treelist/_treeListSearchViewModel';
export class dxFieldListPicker extends dxDropDownBox {
    ...
    _renderPopupContent() {
        ...
        const searchModel = TreeListSearchViewModel.createController(searchBarElement, [this.option('treeListController')]);
        this._searchValue = searchModel.value;
        $dx(this['_popup'].content()).append(searchBarElement);
