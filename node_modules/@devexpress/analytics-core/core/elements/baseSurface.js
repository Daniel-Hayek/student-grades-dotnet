...
export class SurfaceElementBase extends SurfaceElementArea {
    constructor(control, context, unitProperties) {
        ...
        this._disposables.push(this.contentCss = ko.pureComputed(() => {
            return extend({}, this.cssCalculator.fontCss(), this.cssCalculator.foreColorCss(), this.cssCalculator.textAlignmentCss(), this.cssCalculator.angle(), this.cssCalculator.wordWrapCss(), this.cssCalculator.lineSpacingCss(), this.cssCalculator.paddingsCss());
        }));
        this._disposables.push(ko.computed(() => {
