...
export declare class PropertyModificationModel extends Disposable {
...
export declare class ElementViewModel<T extends string = string> extends PropertyModificationModel implements IElementViewModel<T>, IControlPropertiesViewModel<T> {
    ...
    dispose(): void;
    beforeDeserialize(model: any, parent: ElementViewModel<T>, serializer?: IModelSerializer): void;
    afterDeserialize(model: any, parent: ElementViewModel<T>, serializer?: IModelSerializer): void;
