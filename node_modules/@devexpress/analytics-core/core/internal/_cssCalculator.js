...
export class CssCalculator {
    ...
    createLineSpacing(lineSpacing) {
        const marginTop = (1 - lineSpacing) / 2;
    ...
    constructor(control, _rtlLayout) {
        ...
        this.lineSpacingCss = () => {
            return this.createLineSpacing(currentMultiPlatformEngine.unwrap(control['lineSpacing']));
        };
        this.paddingsCss = () => {
        ...
        this.strokeWidthWithWidth = () => {
            const lineWidth = this._getPixelValueFromUnit(currentMultiPlatformEngine.unwrap(control['width']) || '', control);
            return { 'strokeWidth': lineWidth };
        };
