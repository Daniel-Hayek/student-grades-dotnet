...
export declare function unwrapImmidiatePromise<T = any>(promise: DxPromise<T>): T;
export declare function isPromise<T>(object: T | PromiseLike<T>): object is PromiseLike<T>;
export {};
