...
export declare class SubNode {
    ...
    static serializeRelation(relation: RelationViewModel): string[];
    static deserializeRelationModel(subNodeQuery: FederationTableViewModel, relations: RelationViewModel[]): SubNode;
    private _parsePath;
