...
export class ChooseJsonSchemaPageBase extends WizardPageBase {
    _clear() {
        this._rootItems([]);
...
export class ChooseJsonSchemaPage extends ChooseJsonSchemaPageBase {
