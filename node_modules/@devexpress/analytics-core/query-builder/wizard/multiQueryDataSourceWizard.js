...
import { DataSourceWizardPageId, FederationDataSourceWizardPageId, JsonDataSourceWizardPageId, MongoDBDataSourceWizardPageId, ObjectDataSourceWizardPageId, SqlDataSourceWizardPageId } from './pageId';
...
export class MultiQueryDataSourceWizard extends PopupWizard {
    ...
    initialize(state, createIterator = (pageFactory, stateManager) => new MultiQueryDataSourceWizardPageIterator(pageFactory, stateManager, this._wizardOptions)) {
        ...
        else if (this._wizardOptions.mongoDBDataSourceAvailable || !isEmptyObject(state.mongoDBDataSourceWizard)) {
