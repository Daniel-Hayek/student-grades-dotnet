...
export declare class TreeNodeBase extends Disposable implements IDataMemberInfo {
    ...
    constructor(name: string, displayName: string, specifics: string, isChecked?: boolean, afterCheckToggled?: (node: TreeNodeBase) => void, pathParts?: string[]);
...
export declare class TreeLeafNode extends TreeNodeBase {
    ...
    displayName: string;
    specifics: string;
    constructor(name: string, displayName: string, specifics: string, isChecked?: boolean, nodeArguments?: any, afterCheckToggled?: (node: TreeNodeBase) => void, pathParts?: string[]);
...
export declare class TreeQueryNode extends TreeLeafNode {
    query?: any;
    constructor(name: string, displayName: string, specifics: string, isChecked: boolean, parameters: ko.Observable<DataSourceParameter[]>, callbacks: ko.Observable<IAddQueriesTreeListCallbacks>, afterCheckToggled?: (node: TreeLeafNode) => void, query?: any, pathParts?: string[]);
...
export declare class FieldTreeNode extends TreeNodeBase {
    constructor(name: string, displayName: string, specifics: string, isChecked: boolean, pathParts: string[], afterCheckToggled?: (node: TreeNodeBase) => void, isDraggable?: boolean);
...
export declare class DataMemberTreeNode extends TreeNode {
    constructor(name: string, displayName: string, specifics: string, isChecked: boolean, pathParts: string[], afterCheckToggled?: (node: DataMemberTreeNode) => void);
    setChecked(value: boolean): void;
    visible: ko.Observable<boolean>;
