...
declare class FederationDataMemberTreeNode extends DataMemberTreeNode {
    constructor(name: string, displayName: string, specifics: string, isListType: boolean, isChecked: boolean, pathParts: string[], afterCheckToggled?: (node: DataMemberTreeNode) => void);
    isListType: boolean;
}
export {};
