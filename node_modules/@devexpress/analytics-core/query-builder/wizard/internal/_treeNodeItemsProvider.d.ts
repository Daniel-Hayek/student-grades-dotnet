...
export declare class TreeNodeItemsProvider extends Disposable implements IItemsProvider {
    ...
    constructor(fieldListProvider: FieldListProvider, rootItems: ko.ObservableArray<IDataMemberInfo>, generateTreeNode: (item: IDataMemberInfo, isChecked: boolean, pathParts: string[]) => DataMemberTreeNode, generateTreeLeafNode: (item: IDataMemberInfo, isChecked: boolean, pathParts: string[]) => FieldTreeNode);
