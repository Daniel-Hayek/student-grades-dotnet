...
export declare class _DataSourceWizardOptionsBase<T extends IDataSourceWizardCallbacks> {
    ...
    getMongoDBConnectionStrings?: () => JQueryPromise<IConnectionStringDefinition[]>;
}
...
export declare class DataSourceWizardPageIterator extends PageIterator<IDataSourceWizardState> {
