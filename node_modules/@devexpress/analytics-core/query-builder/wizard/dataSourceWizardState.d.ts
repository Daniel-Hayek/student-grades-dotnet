...
export interface IDataSourceWizardState {
    ...
    mongoDBDataSourceWizard?: IMongoDBDataSourceWizardState;
...
export declare let _restoreMongoDBDataSourceFromState: (state: IMongoDBDataSourceWizardState, requestWrapper?: RequestWrapper, dataSourceId?: string) => MongoDBDataSource;
export declare function _setRestoreMongoDBDataSourceFromState(func: (state: IMongoDBDataSourceWizardState, requestWrapper?: RequestWrapper, dataSourceId?: string) => MongoDBDataSource): void;
export declare function _resetRestoreMongoDBDataSourceFromState(): void;
