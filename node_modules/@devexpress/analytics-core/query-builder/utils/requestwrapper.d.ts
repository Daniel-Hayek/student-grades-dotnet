...
export declare class RequestWrapper {
    ...
    getMongoDBQuerySchema(mongoDBDataSource: MongoDBDataSource, query: MongoDBQuery): DxPromise<{
        collectionSchemaJson: string;
    }>;
    getMongoDBCollections(connection: MongoDBDataConnection): DxPromise<IMongoDBCollectionsRespose>;
