/**
* DevExpress Analytics (dx-analytics-core-templates.generated.js)
* Version:  25.2.4
...
SvgTemplatesEngine.addTemplates({
    ...
    'dxrd-filterstring': '<!-- ko if: value --> <div data-bind="dxFilterEditor: { options: value, fieldListProvider: $root.dataBindingsProvider, getDisplayNameByPath: $root.getDisplayNameByPath, displayNameProvider: $root.displayNameProvider && $root.displayNameProvider(), aiExpressionGenerator: $root.aiExpressionGenerator }"></div> <!-- /ko -->',
    'dxrd-filterstringgroup': '<!-- ko if: value --> <div data-bind="dxFilterEditor: { options: value, fieldListProvider: $root.dataBindingsGroupProvider, getDisplayNameByPath: $root.getDisplayNameByPath, displayNameProvider: $root.displayNameProvider && $root.displayNameProvider(), aiExpressionGenerator: $root.aiExpressionGenerator }"></div> <!-- /ko -->',
    ...
    'dx-expressioneditor-main': '<div class="dx-expression-tree"> <!-- ko if: $root.aiExpressionGenerator --> <!-- ko template: { name: \'dx-ai-expression-generator\', data: $root.aiExpressionGenerator.initialize($data) } --> <!-- /ko --> <!-- /ko --> <div class="dxrd-ai-expression-loading-panel-container" data-bind="resizable: resizeHelper.resizable($root.resizeHandler, \'s\', $element)"> <!-- ko if: !aceAvailable --> <div class="dx-expressioneditor-textarea dxd-border-secondary dxd-back-primary2" data-bind="dxTextArea: { value: textAreaValue, isValid: isValid, spellcheck: false, onKeyUp: function() { isValid(true); } }"></div> <!-- /ko --> <!-- ko if: aceAvailable --> <div class="dx-expressioneditor-textarea dxd-border-secondary dxd-back-primary2" data-bind="dxAceEditor: { value: textAreaValue, editorContainer: editorContainer, theme: theme, options: aceOptions, additionalOptions: additionalOptions, callbacks: callbacks }"></div> <!-- /ko --> <!-- ko if: $root.aiExpressionGenerator --> <div class="dxrd-wizard-load-panel dxd-text-primary" data-bind="dxAILoadingPanel: $root.aiExpressionGenerator.getLoadPanelOptions($element)"></div> <!-- /ko --> </div> <div class="dx-expressioneditor-tools"> <!-- ko with: tools--> <div class="dx-expressioneditor-tools-tabs"> <!-- ko foreach: toolBox--> <div data-bind="visible: visible,  attr: { class: \'dx-expressioneditor-tools-tab dxd-back-primary2 \'+ ($data.templateName ? $data.templateName : \'\')}"> <!-- ko if: $data.templateName --> <!-- ko template: { name: $data.templateName }--> <!-- /ko --> <!-- /ko --> </div> <!-- /ko--> </div> <!-- /ko--> </div> </div>',
    ...
    'dx-ai-expression-generator': '<div class="dx-ai-expression-generator"> <div data-bind="template: { name: \'dxrd-svg-actions-ai_localization_service\' }" class="dxd-icon-accented dxrd-ai-expression-generator-editor-icon"></div> <div data-bind="dxTextArea: { value: expressionInNL, width: \'100%\', valueChangeEvent: \'keyup\', placeholder: _promptPlaceholder, autoResizeEnabled: true, maxHeight: \'90px\', buttons: buttons }"> </div> </div>',
    ...
    'dx-filtereditor-content': '<div class="dx-filtereditor-content"> <!-- ko if: !!aiFilterGenerator --> <!-- ko template: { name: \'dx-ai-expression-generator\', data: aiFilterGenerator } --> <!-- /ko --> <!-- /ko --> <div class="dxrd-ai-expression-loading-panel-container"> <!-- ko if: !!aiFilterGenerator --> <div class="dxrd-wizard-load-panel dxd-text-primary" data-bind="dxAILoadingPanel: aiFilterGenerator.getLoadPanelOptions($element)"></div> <!-- /ko --> <div class="dx-filtereditor-tree-container" data-bind="css: { \'advanced\': advancedMode }"> <!-- ko template: \'dx-filtereditor-content-tree\' --> <!-- /ko --> </div> <div class="dx-filtereditor-text-container" data-bind="css: { \'advanced\': advancedMode }, visible: textVisible"> <!-- ko template: \'dx-filtereditor-content-text\'--> <!-- /ko --> </div> </div> </div>',
    ...
    'dx-filtereditor': '<div> <div class="no-margin-right" data-bind="dxEllipsisEditor: { value: modelDisplayValue, isValid: modelValueIsValid, disabled: disabled, buttonAction: function() { popupVisible(true); }, inputAttr: { id: editorInputId } }"></div> <div data-bind="dxEditorPopupTemplate: { data: $data, templateName: \'dx-filtereditor-popup\' }"></div> </div>',
    ...
    'dx-treelist-item-actions-container': '<div class="dx-treelist-action-container" data-bind="visible: isSelected || isHovered, click: function(s, e) { e.stopPropagation(); }"> <!-- ko template: actionsTemplate --> <!-- /ko --> </div>',
    'dx-treelist-header-item': '<div role="treeitem" class="dx-treelist-item dxd-list-item-back-color dxd-back-highlighted dx-accessibility-treelist-item dx-accessibility-focus-border-accented" data-bind="event: events, click: function(s, e) { $root.hideContextMenu && $root.hideContextMenu(); toggleSelected(s, e); }, styleunit: padding, draggable: isDraggable ? dragDropHandler : null, css: cssRules, attr: attr"> <!-- ko if: hasItems--> <div class="dx-treelist-collapsedbutton" data-bind="css: nodeImageClass, template: \'dxrd-svg-collapsed\', click: toggleCollapsed"></div> <!-- /ko --> <div class="dx-treelist-caption" data-bind="style: { \'padding-left\': hasItems ? \'0px\': \'18px\' }"> <!-- ko if: actions && actions.length > 0 --> <!-- ko template: templates.actionsContainer --> <!-- /ko  --> <!-- /ko  --> <div class="dx-treelist-selectedcontent"> <!-- ko template: templates.headerItemContent --> <!-- /ko --> </div> </div> </div>',
