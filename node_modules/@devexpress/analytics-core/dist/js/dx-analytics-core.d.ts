...
declare module DevExpress.Analytics.Serializer.Native {
    import IDisposableViewModel = DevExpress.Analytics.Utils.IDisposableViewModel;
    ...
    import DisposableViewModel = DevExpress.Analytics.Utils.DisposableViewModel;
    ...
    export interface IViewModel<T = unknown> extends IDisposableViewModel {
        getModel?: () => T;
    }
    ...
    export class ViewModel extends DisposableViewModel implements IViewModel {
        private _model;
...
declare module DevExpress.Analytics.Utils {
    ...
    export interface ISerializableModel {
        ...
        shouldSerialize?: (propertyName: string, viewModel: any) => boolean;
    }
    ...
    export interface IDisposableViewModel {
        disposeViewModel?: () => void;
        disposeSubscription?: (subscription: DisposeFunctionType) => void;
        addDisposable?: (disposable: DisposeFunctionType) => void;
    }
    export class DisposableViewModel implements IDisposableViewModel {
    ...
    export function _getPathPartsFromRequest(request: DevExpress.Analytics.Utils.IPathRequest): string[];
    ...
    export interface IComponent {
        name: DevExpress.Analytics.Serializer.Native.MultiPlatformObservable<string> | DevExpress.Analytics.Serializer.Native.MultiPlatformComputed<string>;
    }
...
declare module DevExpress.Analytics.Internal {
    ...
    export class DxDeferred<T = any> {
        ...
        then(callback: (...args: T[]) => void, failCallback?: (...args: any[]) => void): any;
    ...
    export function unwrapImmidiatePromise<T = any>(promise: DevExpress.Analytics.Internal.DxPromise<T>): T;
    export function isPromise<T>(object: T | PromiseLike<T>): object is PromiseLike<T>;
    export {};
    ...
    export type MeasureUnit = "HundredthsOfAnInch" | "TenthsOfAMillimeter" | "Pixels" | "Inches" | "Millimeters";
    ...
    export class CssCalculator {
        ...
        createLineSpacing(lineSpacing?: number): {
            "line-height": string;
            "margin-top": string;
            overflow: string;
    ...
    export class SnapLinesHelper {
        ...
        getSnappingMode(): string;
        roundToGridSize(value: any): number;
        snapToGrid(uiElement: any, dropTarget: any): void;
    ...
    export class KeyDownHandlersManager extends Disposable {
        private _handlers;
        private _targetElement;
        private get _activeHandler();
        _removeHandler(handler: (e: JQueryKeyEventObject) => void, eventName: string): void;
        dispose(): void;
    ...
    export function initializeResize(element: HTMLElement, options: IResizableOptions, elementModel?: any): () => void;
    export class Resizable extends Disposable {
        private _element;
        private _options;
        private _elementModel?;
    ...
    export class AccordionKeyboardHelper extends AccessibilityKeyboardHelperBase {
        ...
        controlElementClassName: string;
        editorId: string;
        constructor(_editorViewModelsAccessor: () => DevExpress.Analytics.Widgets.ICollapsedViewModel, _onToggleCollapsed?: () => void, editorId?: string);
    ...
    export class ContextMenuProvider extends Disposable {
        ...
        hide(): void;
        dispose(): void;
        getPopupContainer(containerSelector: string): Element | undefined;
    ...
    export let sendRequest: <T = any>(...params: (IAjaxSettings | any)[]) => DevExpress.Analytics.Internal.DxPromise<T>;
...
declare module DevExpress.Analytics.Widgets.Internal {
    ...
    export interface ICriteriaEditorContext {
        isFilter: boolean;
        value: string;
    }
    export abstract class CriteriaEditorBase extends PopupEditorBase {
        private resizeListeners;
        abstract getEditorContext(): ICriteriaEditorContext;
        addResizeListener(listener: () => any): void;
        setCriteriaValue(value: string): void;
        resizeAceEditor(): void;
        protected notifyResizeListeners(): void;
    ...
    export class TreeListSearchViewModel extends Disposable {
        static createController(element: Element, controllers: DevExpress.Analytics.Widgets.Internal.ITreeListController[], modelType?: typeof TreeListSearchViewModel, templateName?: string): TreeListSearchViewModel;
    ...
    export class dxFieldListPicker extends dxDropDownBox {
        ...
        _searchValue: ko.Observable<string> | ko.Computed<string>;
    ...
    export class dxEllipsisEditor extends dxTextBox<EllipsisEditorOptions> {
        ...
        _updateOptions(options: EllipsisEditorOptions): void;
...
declare module DevExpress.Analytics.Widgets {
    ...
    import CriteriaEditorBase = DevExpress.Analytics.Widgets.Internal.CriteriaEditorBase;
    ...
    export class Editor extends BaseRenderingMultiplatformModel<DevExpress.Analytics.Widgets.IEditorViewModel> {
        ...
        private _roundTwoDecimalsForUnitProperties;
        private _init;
    ...
    export class ExpressionEditor extends CriteriaEditorBase {
        private options;
        ...
        constructor(options: IExpressionOptions, fieldListProvider: ko.Observable<DevExpress.Analytics.Utils.IItemsProvider> | ko.Computed<DevExpress.Analytics.Utils.IItemsProvider>, disabled?: DevExpress.Analytics.Serializer.Native.MultiPlatformComputed<boolean> | DevExpress.Analytics.Serializer.Native.MultiPlatformObservable<boolean>, rtl?: boolean, _displayNameProvider?: DevExpress.Analytics.Utils.IDisplayNameProvider, popupVisible?: ko.Observable<boolean>, editorInputId?: string);
        ...
        disabled: DevExpress.Analytics.Serializer.Native.MultiPlatformObservable<boolean> | DevExpress.Analytics.Serializer.Native.MultiPlatformComputed<boolean>;
        onShown(): void;
        onHiding(e: {
            component: any;
            element: HTMLElement;
        ...
        getValue(): string;
        setCriteriaValue(value: string): void;
        getEditorContext(): DevExpress.Analytics.Widgets.Internal.ICriteriaEditorContext;
        validate: (value: any, sender?: any) => boolean;
        getPopupContainer: typeof DevExpress.Analytics.Internal.getParentContainer;
        showAISparkle: ko.Observable<boolean>;
    }
    export class FilterEditorHelper {
        private static _customExpressions;
        static addCustomExpression: (customExpression: FilterEditorCustomOperator) => void;
        ...
        registrateOperator(specific: string, targetEnum: any, value: string, name: string, operatorType?: string, reverse?: boolean, localizationId?: string, insertVal?: string): void;
        rtl: boolean;
        ...
        filterEditorOperators: {
            ...
            custom: DevExpress.Analytics.Criteria.Utils.ICriteriaChangeOperator[];
        };
        onChange: () => void;
    ...
    interface FilterEditorCustomOperator {
        description: string;
        category: string;
        name: string;
        localizationId: string;
    ...
    export class AIExpressionGenerator extends Disposable {
        model: any;
        constructor(model: any, uri: string, errorCallback: (errorMessage: string) => void);
        reset(): void;
        initialize(editor: any): this;
        getLoadPanelOptions(element: HTMLElement): {
            visible: ko.Observable<boolean>;
            position: {
                of: HTMLElement;
            };
        ...
        getLoadingPanelContainer(element: HTMLElement): HTMLElement;
        generateAndApplyExpression(): void;
        applyExpression(): void;
        failRequestHandler(errorMessage: string): void;
        generateExpression(): any;
        buttons: ko.PureComputed<({
            name: string;
            location: string;
            options: {
                icon: string;
        ...
        dispose(): void;
        expressionInNL: ko.Observable<string>;
        generatedExpressionResult: ko.Observable<string>;
        isLoading: ko.Observable<boolean>;
        generationDisabled: ko.Computed<boolean>;
        handleUri: string;
        errorCallback: (errorMessage: string) => void;
        container: any;
        editor: DevExpress.Analytics.Widgets.Internal.CriteriaEditorBase;
        applyDisabled: ko.Observable<boolean>;
        dxGenerateExpressionDeferred: DevExpress.Analytics.Internal.DxDeferred;
        _promptPlaceholder: any;
    }
    export {};
    /// <reference types="jquery" />
    /// <reference types="jquery" />
    ...
    export class FilterEditor extends CriteriaEditorBase {
        ...
        disabled: ko.Observable<boolean> | ko.Computed<boolean>;
        editorInputId: string;
        aiFilterGenerator: DevExpress.Analytics.Widgets.AIExpressionGenerator;
        dispose(): void;
...
declare module DevExpress.Analytics.Elements {
    ...
    export class PropertyModificationModel extends Disposable {
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
    ...
    export class ElementViewModel<T extends string = string> extends PropertyModificationModel implements IElementViewModel<T>, IControlPropertiesViewModel<T> {
        ...
        dispose(): void;
        beforeDeserialize(model: any, parent: DevExpress.Analytics.Elements.ElementViewModel<T>, serializer?: DevExpress.Analytics.Utils.IModelSerializer): void;
        afterDeserialize(model: any, parent: DevExpress.Analytics.Elements.ElementViewModel<T>, serializer?: DevExpress.Analytics.Utils.IModelSerializer): void;
...
declare module DevExpress.Analytics.Data {
    ...
    import DataConnectionBase = DevExpress.Analytics.Data.Metadata.DataConnectionBase;
    ...
    import MongoDBQuery = DevExpress.Analytics.Data.MongoDBQuery;
    import IMongoDBCollectionsRespose = DevExpress.QueryBuilder.Utils.IMongoDBCollectionsRespose;
    import MongoDBSchemaProvider = DevExpress.Analytics.Data.MongoDBSchemaProvider;
    import MongoDBDataConnection = DevExpress.Analytics.Data.MongoDBDataConnection;
    import IDataMemberInfo = DevExpress.Analytics.Utils.IDataMemberInfo;
    ...
    export class SqlDataConnection extends DataConnectionBase {
    ...
    export class FederationSource extends Disposable {
        constructor(model: any, serializer?: any, pathParts?: string[], sourceName?: string);
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
    ...
    export class SubNode {
        ...
        static serializeRelation(relation: DevExpress.QueryBuilder.Elements.RelationViewModel): string[];
        static deserializeRelationModel(subNodeQuery: DevExpress.QueryBuilder.Internal.FederationTableViewModel, relations: DevExpress.QueryBuilder.Elements.RelationViewModel[]): DevExpress.Analytics.Data.SubNode;
        private _parsePath;
    ...
    export const mongoDBQuerySerializationInfo: DevExpress.Analytics.Utils.ISerializationInfoArray;
    export class MongoDBQuery {
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
        static fromCollection(state: IMongoDBCollection): DevExpress.Analytics.Data.MongoDBQuery;
        toCollection(): IMongoDBCollection;
        get hash(): string;
        constructor(model?: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer);
        databaseName: ko.Observable<string> | ko.Computed<string>;
        collectionName: ko.Observable<string> | ko.Computed<string>;
        alias: ko.Observable<string> | ko.Computed<string>;
        filterString: ko.Observable<string> | ko.Computed<string>;
        id: ko.Observable<string>;
        schema: DevExpress.Analytics.Data.JsonSchemaRootNode;
    }
    export let getMongoDBSchemaCallback: (requestWrapper: DevExpress.QueryBuilder.Utils.RequestWrapper, dataSource: DevExpress.Analytics.Data.MongoDBDataSource, query: DevExpress.Analytics.Data.MongoDBQuery) => DevExpress.Analytics.Internal.DxPromise<JsonSchemaRootNode>;
    export function _setGetMongoDBSchemaCallback(func: any): void;
    export function _resetGetMongoDBSchemaCallback(): void;
    export class MongoDBSchemaProvider {
        private _dataSource;
        private _requestWrapper;
        private _schemaPromises;
        constructor(_dataSource: DevExpress.Analytics.Data.MongoDBDataSource, _requestWrapper: DevExpress.QueryBuilder.Utils.RequestWrapper);
        getQuerySchema(query: DevExpress.Analytics.Data.MongoDBQuery): DevExpress.Analytics.Internal.DxPromise<JsonSchemaRootNode>;
    }
    export class MongoDBDataConnection extends DataConnectionBase {
        static from(json: string): DevExpress.Analytics.Data.MongoDBDataConnection;
        serialize(): string;
    }
    export class MongoDBDataSource implements IDataSourceBase {
        private _requestWrapper;
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
        saveQueries(): any[];
        constructor(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer, _requestWrapper?: DevExpress.QueryBuilder.Utils.RequestWrapper);
        getAvailableCollections(): DevExpress.Analytics.Internal.DxPromise<IMongoDBCollectionsRespose>;
        getQuerySchema(query: DevExpress.Analytics.Data.MongoDBQuery): DevExpress.Analytics.Internal.DxPromise<JsonSchemaRootNode>;
        loadQueries(): DevExpress.Analytics.Internal.DxPromise<JsonSchemaRootNode[]>;
        name: ko.Observable<string> | ko.Computed<string>;
        id: string;
        schemaProvider: DevExpress.Analytics.Data.MongoDBSchemaProvider;
        queries: ko.ObservableArray<DevExpress.Analytics.Data.MongoDBQuery>;
        connection: DevExpress.Analytics.Data.MongoDBDataConnection;
    }
...
declare module DevExpress.Analytics.Data.Metadata {
    ...
    export const dataConnectionSerializationInfo: DevExpress.Analytics.Utils.ISerializationInfoArray;
    export class DataConnectionBase {
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
        constructor(model?: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer);
        name: ko.Observable<string>;
...
declare module DevExpress.Analytics.Data.Internal {
    ...
    export function _processJsonSchemaResponse(schema: DevExpress.Analytics.Internal.DxPromise<string>): DevExpress.Analytics.Internal.DxPromise<JsonSchemaRootNode>;
...
declare module DevExpress.QueryBuilder.Utils {
    ...
    export interface IMongoDBDataBaseDescription {
        databaseName: string;
        collections: string[];
    }
    export interface IMongoDBCollectionsRespose {
        mongoDBCollections: IMongoDBDataBaseDescription[];
    }
    export class RequestWrapper {
        ...
        getMongoDBQuerySchema(mongoDBDataSource: DevExpress.Analytics.Data.MongoDBDataSource, query: DevExpress.Analytics.Data.MongoDBQuery): DevExpress.Analytics.Internal.DxPromise<{
            collectionSchemaJson: string;
        }>;
        getMongoDBCollections(connection: DevExpress.Analytics.Data.MongoDBDataConnection): DevExpress.Analytics.Internal.DxPromise<IMongoDBCollectionsRespose>;
...
declare module DevExpress.QueryBuilder.Internal {
    ...
    export class FederationTableViewModel extends TableViewModel {
        constructor(model: any, parent: FederationQueryViewModel, pathParts: string[], serializer?: DevExpress.Analytics.Utils.ModelSerializer);
        queryType: ko.Observable<string> | ko.Computed<string>;
        path: string[];
    ...
    export class JsonSchemaFieldListProviderFactory {
        static _getNodesByPath(pathRequest: DevExpress.Analytics.Utils.IPathRequest, parentNode: DevExpress.Analytics.Data.JsonNode): DevExpress.Analytics.Data.JsonNode[];
        static _getInnerItemsByPath(pathRequest: DevExpress.Analytics.Utils.IPathRequest, parentNode: DevExpress.Analytics.Data.JsonNode): DevExpress.Analytics.Utils.IDataMemberInfo[];
        static _createFieldListCallback(createRootNode: () => DevExpress.Analytics.Internal.DxPromise<JsonNode>): (pathRequest: DevExpress.Analytics.Utils.IPathRequest) => DevExpress.Analytics.Internal.DxPromise<IDataMemberInfo[]>;
        static _nodetoDataMemberInfo(node: DevExpress.Analytics.Data.JsonNode): DevExpress.Analytics.Utils.IDataMemberInfo;
        static create(createRootNode: () => DevExpress.Analytics.Internal.DxPromise<JsonNode>, rootItems: ko.ObservableArray<DevExpress.Analytics.Internal.IDataSourceInfo>): DevExpress.Analytics.Internal.FieldListProvider;
    }
    ...
    export function serializeDataConnection(connection: DevExpress.Analytics.Data.Metadata.DataConnectionBase): string;
...
declare module DevExpress.Analytics.Wizard {
    ...
    import IMongoDBDataSourceWizardState = DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState;
    import IMongoDBDataBaseDescription = DevExpress.QueryBuilder.Utils.IMongoDBDataBaseDescription;
    import Properties = DevExpress.ui.dxDataGrid.Properties;
    import IMongoDBCollection = DevExpress.Analytics.Data.IMongoDBCollection;
    import FilterStringOptions = DevExpress.Analytics.Widgets.FilterStringOptions;
    import FieldListProvider = DevExpress.Analytics.Internal.FieldListProvider;
    import ChooseJsonSchemaPageBase = DevExpress.Analytics.Wizard.ChooseJsonSchemaPageBase;
    import MongoDBQuery = DevExpress.Analytics.Data.MongoDBQuery;
    ...
    export interface IDataSourceWizardState {
        ...
        mongoDBDataSourceWizard?: DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState;
    ...
    export let _restoreMongoDBDataSourceFromState: (state: DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState, requestWrapper?: DevExpress.QueryBuilder.Utils.RequestWrapper, dataSourceId?: string) => DevExpress.Analytics.Data.MongoDBDataSource;
    export function _setRestoreMongoDBDataSourceFromState(func: (state: DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState, requestWrapper?: DevExpress.QueryBuilder.Utils.RequestWrapper, dataSourceId?: string) => DevExpress.Analytics.Data.MongoDBDataSource): void;
    export function _resetRestoreMongoDBDataSourceFromState(): void;
    ...
    export interface IDataSourceWizardConnectionStrings {
        ...
        mongodb?: ko.ObservableArray<DevExpress.Analytics.Wizard.IConnectionStringDefinition>;
    }
    ...
    export class ChooseAvailableItemPage extends WizardPageBase {
        ...
        constructor(items: ko.Subscribable<DevExpress.Analytics.Wizard.IConnectionStringDefinition[]>, canCreateNew?: boolean, _getJsonConnectionsCallback?: () => JQueryPromise<DevExpress.Analytics.Wizard.IConnectionStringDefinition[]>);
        canNext(): boolean;
    ...
    export abstract class ChooseJsonSchemaPageBase<TSource extends DevExpress.Analytics.Data.IDataSourceBase, TState> extends WizardPageBase<TState, TState> {
        protected _requestWrapper: DevExpress.QueryBuilder.Utils.RequestWrapper;
        protected _rootItems: ko.ObservableArray<DevExpress.Analytics.Utils.IDataMemberInfo & {
            data: DevExpress.Analytics.Data.JsonNode;
        }>;
        private _fieldListItemsProvider;
        private _fieldSelectedPath;
        protected _dataSource: TSource;
        protected _clear(): void;
        protected _createRootNode(): DevExpress.Analytics.Internal.DxPromise<JsonNode>;
        protected _getSchemaToDataMemberInfo(root: DevExpress.Analytics.Data.JsonSchemaRootNode, path: DevExpress.Analytics.Utils.IPathRequest): DevExpress.Analytics.Data.JsonNode;
        private _createTreeNode;
        private _createLeafTreeNode;
        protected _updateFieldListProvider(): void;
        protected _resetSelectionRecursive(currentNode: DevExpress.Analytics.Data.JsonNode, selectedRootElement: DevExpress.Analytics.Data.JsonNode): void;
        protected _mapJsonSchema(jsonNode: DevExpress.Analytics.Data.JsonNode, path: DevExpress.Analytics.Utils.IPathRequest): DevExpress.Analytics.Data.JsonNode;
    ...
    export class ChooseJsonSchemaPage extends ChooseJsonSchemaPageBase<DevExpress.Analytics.Data.JsonDataSource, DevExpress.Analytics.Wizard.IJsonDataSourceWizardState> {
        ...
        private _updatePage;
        constructor(requestWrapper?: DevExpress.QueryBuilder.Utils.RequestWrapper, _allowObjectRootElements?: boolean, _callbacks?: DevExpress.Analytics.Wizard.Internal.IJsonDataSourceWizardCallbacks);
    ...
    export class ChooseMongoDBDataConnectionPage extends ChooseAvailableItemPage {
        ...
        initialize(state: DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState): any;
        _getSelectedItem(state: DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState): DevExpress.Analytics.Internal.IDataSourceInfo;
    }
    export function _registerChooseMongoDBDataConnectionPage(factory: DevExpress.Analytics.Wizard.PageFactory, wizardOptions: DevExpress.Analytics.Wizard._DataSourceWizardOptions): void;
    /// <reference types="jquery" />
    export class ChooseMongoDBCollectionPage extends WizardPageBase<DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState, DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState> {
        ...
        constructor(_requestWrapper?: DevExpress.QueryBuilder.Utils.RequestWrapper, rtl?: boolean);
        _addCollection(): void;
        commit(): JQuery.Promise<DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState, any, any>;
        canNext(): boolean;
        initialize(state: DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState): JQuery.Promise<any, any, any>;
        dispose(): void;
        _filterEditorOptions: ko.Observable<DevExpress.Analytics.Widgets.FilterStringOptions>;
        _filedListProvider: ko.Observable<DevExpress.Analytics.Internal.FieldListProvider>;
        _filterEditorVisible: ko.Observable<boolean>;
        _availableCollections: DevExpress.QueryBuilder.Utils.IMongoDBDataBaseDescription[];
        _collections: ko.ObservableArray<DevExpress.Analytics.Data.IMongoDBCollection>;
        _collectionsGrid: DevExpress.ui.dxDataGrid.Properties;
        _isValid: ko.Observable<boolean>;
        _addQueryDisabled: ko.Observable<boolean>;
    }
    export function _registerChooseMongoDBCollectionPage(factory: DevExpress.Analytics.Wizard.PageFactory, requestWrapper: DevExpress.QueryBuilder.Utils.RequestWrapper, rtl: boolean): void;
    /// <reference types="jquery" />
    export class ChooseMongoDBSchemaPage extends ChooseJsonSchemaPageBase<DevExpress.Analytics.Data.MongoDBDataSource, DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState> {
        ...
        protected _createRootNode(): JQuery.Promise<any, any, any>;
        constructor(requestWrapper?: DevExpress.QueryBuilder.Utils.RequestWrapper);
        initialize(state: DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState): JQuery.Promise<any, any, any>;
        commit(): JQuery.Promise<DevExpress.Analytics.Wizard.IMongoDBDataSourceWizardState, any, any>;
        _querySelectBoxTitle: any;
        _availableQueries: ko.Observable<string[]>;
        _selectedQueryName: ko.Observable<string>;
        _selectedQuery: DevExpress.Analytics.Data.MongoDBQuery;
        _isLoading: ko.Observable<boolean>;
    }
    export function _registerChooseMongoDBSchemaPage(factory: DevExpress.Analytics.Wizard.PageFactory, requestWrapper?: DevExpress.QueryBuilder.Utils.RequestWrapper): void;
    /// <reference types="jquery" />
    export class _DataSourceWizardOptionsBase<T extends DevExpress.Analytics.Wizard.Internal.IDataSourceWizardCallbacks> {
        ...
        getMongoDBConnectionStrings?: () => JQueryPromise<DevExpress.Analytics.Wizard.IConnectionStringDefinition[]>;
    }
    ...
    export class DataSourceWizardPageIterator extends PageIterator<DevExpress.Analytics.Wizard.IDataSourceWizardState> {
    ...
    export class FullscreenWizardPage extends WizardPageBase {
        ...
        _loadPanelViewModel(element: any, isLoading: any): {};
    ...
    export function _registerSpecifyMongoDBDataSourceSettingsPage(factory: DevExpress.Analytics.Wizard.FullscreenWizardPageFactory, dataSourceWizardOptions: DevExpress.Analytics.Wizard._DataSourceWizardOptions): void;
...
declare module DevExpress.Analytics.Wizard.Internal {
    ...
    export class TreeNodeBase extends Disposable implements IDataMemberInfo {
        ...
        constructor(name: string, displayName: string, specifics: string, isChecked?: boolean, afterCheckToggled?: (node: DevExpress.Analytics.Wizard.Internal.TreeNodeBase) => void, pathParts?: string[]);
    ...
    export class TreeLeafNode extends TreeNodeBase {
        ...
        displayName: string;
        specifics: string;
        constructor(name: string, displayName: string, specifics: string, isChecked?: boolean, nodeArguments?: any, afterCheckToggled?: (node: DevExpress.Analytics.Wizard.Internal.TreeNodeBase) => void, pathParts?: string[]);
    ...
    export class TreeQueryNode extends TreeLeafNode {
        query?: any;
        constructor(name: string, displayName: string, specifics: string, isChecked: boolean, parameters: ko.Observable<DevExpress.Analytics.Data.DataSourceParameter[]>, callbacks: ko.Observable<DevExpress.Analytics.Wizard.Internal.IAddQueriesTreeListCallbacks>, afterCheckToggled?: (node: TreeLeafNode) => void, query?: any, pathParts?: string[]);
    ...
    export class FieldTreeNode extends TreeNodeBase {
        constructor(name: string, displayName: string, specifics: string, isChecked: boolean, pathParts: string[], afterCheckToggled?: (node: DevExpress.Analytics.Wizard.Internal.TreeNodeBase) => void, isDraggable?: boolean);
        visible: ko.Observable<boolean>;
        isComplex: boolean;
        dragData: any;
        disabled: ko.Observable<boolean>;
    ...
    export class TreeNodeItemsProvider extends Disposable implements IItemsProvider {
        ...
        constructor(fieldListProvider: DevExpress.Analytics.Internal.FieldListProvider, rootItems: ko.ObservableArray<DevExpress.Analytics.Utils.IDataMemberInfo>, generateTreeNode: (item: DevExpress.Analytics.Utils.IDataMemberInfo, isChecked: boolean, pathParts: string[]) => DevExpress.Analytics.Wizard.Internal.DataMemberTreeNode, generateTreeLeafNode: (item: DevExpress.Analytics.Utils.IDataMemberInfo, isChecked: boolean, pathParts: string[]) => DevExpress.Analytics.Wizard.Internal.FieldTreeNode);
    ...
    export class FederationQueryBuilderPopupBase extends PopupEditorBase {
        ...
        dispose(): void;
        addDataMember(item: DevExpress.Analytics.Widgets.Internal.ITreeListItemViewModel | DevExpress.Analytics.Widgets.Internal.TreeListItemViewModel, position?: {
            left: number;
            top: number;
        }): void;
        save(): void;
    ...
    export class FederationTransformQueryBuilderPopup extends FederationQueryBuilderPopupBase {
        ...
        dispose(): void;
        addDataMember(item: DevExpress.Analytics.Widgets.Internal.ITreeListItemViewModel | DevExpress.Analytics.Widgets.Internal.TreeListItemViewModel): void;
        updateColumns(): void;
        canSave(): boolean;
        save(): void;
        onHiding(): void;
    ...
    class FederationDataMemberTreeNode extends DataMemberTreeNode {
        constructor(name: string, displayName: string, specifics: string, isListType: boolean, isChecked: boolean, pathParts: string[], afterCheckToggled?: (node: DevExpress.Analytics.Wizard.Internal.DataMemberTreeNode) => void);
        isListType: boolean;
    }
    export {};
