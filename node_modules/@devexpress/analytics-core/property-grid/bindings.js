...
ko.bindingHandlers['dxdAccordionExt'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        const onCollapsedChanged = (newVal) => {
            if (newVal) {
                ...
                if (accordionContentHTML) {
                    ...
                    ko.cleanNode($accordionContent.get(0));
        ...
        addDisposeCallback(element, () => ko.cleanNode(element));
...
ko.bindingHandlers['dxLocalizedSelectBox'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        const extendedOptions = ko.computed(() => {
        ...
        addDisposeCallback(element, () => extendedOptions.dispose());
