...
export class ObjectProperties extends BaseRenderingMultiplatformModel {
    ...
    cleanSubscriptions() {
        this._infoSubscription.forEach(subscription => subscription && subscription());
...
export class PropertyGridEditor extends Editor {
    ...
    dispose() {
        super.dispose();
        this.viewmodel && this.viewmodel.dispose();
        this.viewmodel = null;
        this._isSearchedPropertySubscription && this._isSearchedPropertySubscription();
        this._isSearchedPropertySubscription = null;
    }
