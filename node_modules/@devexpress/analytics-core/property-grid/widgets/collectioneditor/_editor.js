...
function createCollectionEditorViewModelItem(x, i, editor) {
    ...
    const viewModel = createViewModelGenerator()
        ...
        if (!objectProperties) {
            objectProperties = new ObjectProperties(x, options?.editorsInfo ?? undefined, options?.level ?? editor.level + 1, options?.disabled ?? disabled, false, undefined, undefined, undefined, options?.engineType);
