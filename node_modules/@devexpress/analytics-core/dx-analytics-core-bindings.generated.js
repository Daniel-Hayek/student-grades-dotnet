/**
* DevExpress Analytics (dx-analytics-core-bindings.generated.js)
* Version:  25.2.4
...
addToBindingsCache('resizable: resizeHelper.resizable($root.resizeHandler, \'s\', $element)', function ($context, $element) { return { 'resizable': function () { return $context.$data.resizeHelper.resizable($context.$root.resizeHandler, 's', $element); } }; });
addToBindingsCache('dxTextArea: { value: textAreaValue, isValid: isValid, spellcheck: false, onKeyUp: function() { isValid(true); } }', function ($context, $element) { return { 'dxTextArea': function () { return { 'value': $context.$data.textAreaValue, 'isValid': $context.$data.isValid, 'spellcheck': false, 'onKeyUp': function () { $context.$data.isValid(true); } }; } }; });
addToBindingsCache('dxAceEditor: { value: textAreaValue, editorContainer: editorContainer, theme: theme, options: aceOptions, additionalOptions: additionalOptions, callbacks: callbacks }', function ($context, $element) { return { 'dxAceEditor': function () { return { 'value': $context.$data.textAreaValue, 'editorContainer': $context.$data.editorContainer, 'theme': $context.$data.theme, 'options': $context.$data.aceOptions, 'additionalOptions': $context.$data.additionalOptions, 'callbacks': $context.$data.callbacks }; } }; });
addToBindingsCache('dxAILoadingPanel: $root.aiExpressionGenerator.getLoadPanelOptions($element)', function ($context, $element) { return { 'dxAILoadingPanel': function () { return $context.$root.aiExpressionGenerator.getLoadPanelOptions($element); } }; });
...
addToBindingsCache('if: $root.aiExpressionGenerator', function ($context, $element) { return { 'if': function () { return $context.$root.aiExpressionGenerator; } }; });
addToBindingsCache('template: { name: \'dx-ai-expression-generator\', data: $root.aiExpressionGenerator.initialize($data) }', function ($context, $element) { return { 'template': function () { return { 'name': 'dx-ai-expression-generator', 'data': $context.$root.aiExpressionGenerator.initialize($context.$data) }; } }; });
...
addToBindingsCache('template: { name: \'dxrd-svg-actions-ai_localization_service\' }', function ($context, $element) { return { 'template': function () { return { 'name': 'dxrd-svg-actions-ai_localization_service' }; } }; });
addToBindingsCache('dxTextArea: { value: expressionInNL, width: \'100%\', valueChangeEvent: \'keyup\', placeholder: _promptPlaceholder, autoResizeEnabled: true, maxHeight: \'90px\', buttons: buttons }', function ($context, $element) { return { 'dxTextArea': function () { return { 'value': $context.$data.expressionInNL, 'width': '100%', 'valueChangeEvent': 'keyup', 'placeholder': $context.$data._promptPlaceholder, 'autoResizeEnabled': true, 'maxHeight': '90px', 'buttons': $context.$data.buttons }; } }; });
...
addToBindingsCache('visible: visible, click: toggleSelected, event: { dblclick: function() { actions[0].clickAction($element); }}, styleunit: padding, css: { \'dx-treelist-item-selected dxd-state-selected\': isSelected }', function ($context, $element) { return { 'visible': function () { return $context.$data.visible; }, 'click': function () { return $context.$data.toggleSelected; }, 'event': function () { return { 'dblclick': function () { $context.$data.actions[0].clickAction($element); } }; }, 'styleunit': function () { return $context.$data.padding; }, 'css': function () { return { 'dx-treelist-item-selected dxd-state-selected': $context.$data.isSelected }; } }; });
...
addToBindingsCache('dxAILoadingPanel: aiFilterGenerator.getLoadPanelOptions($element)', function ($context, $element) { return { 'dxAILoadingPanel': function () { return $context.$data.aiFilterGenerator.getLoadPanelOptions($element); } }; });
...
addToBindingsCache('if: !!aiFilterGenerator', function ($context, $element) { return { 'if': function () { return !!$context.$data.aiFilterGenerator; } }; });
addToBindingsCache('template: { name: \'dx-ai-expression-generator\', data: aiFilterGenerator }', function ($context, $element) { return { 'template': function () { return { 'name': 'dx-ai-expression-generator', 'data': $context.$data.aiFilterGenerator }; } }; });
...
addToBindingsCache('dxEditorPopupTemplate: { data: $data, templateName: \'dx-filtereditor-popup\' }', function ($context, $element) { return { 'dxEditorPopupTemplate': function () { return { 'data': $context.$data, 'templateName': 'dx-filtereditor-popup' }; } }; });
...
addToBindingsCache('dxEditorPopupTemplate: { data: $data, templateName: \'dx-formatstring-popup-template\' }', function ($context, $element) { return { 'dxEditorPopupTemplate': function () { return { 'data': $context.$data, 'templateName': 'dx-formatstring-popup-template' }; } }; });
addToBindingsCache('dxPopup: { wrapperAttr: { class: \'dx-format-string dx-popup-general\' }, showTitle: true, width: \'95%\', height: \'95%\', minWidth: 650, title: getDisplayText(\'title\'), visible: popupVisible(), toolbarItems: buttonItems, showCloseButton: true, container: getPopupContainer($element), position: { of: getPopupContainer($element) }, onHidden: onHiddenHandler, hideOnParentScroll: false, }', function ($context, $element) { return { 'dxPopup': function () { return { 'wrapperAttr': { 'class': 'dx-format-string dx-popup-general' }, 'showTitle': true, 'width': '95%', 'height': '95%', 'minWidth': 650, 'title': $context.$data.getDisplayText('title'), 'visible': $context.$data.popupVisible(), 'toolbarItems': $context.$data.buttonItems, 'showCloseButton': true, 'container': $context.$data.getPopupContainer($element), 'position': { 'of': $context.$data.getPopupContainer($element) }, 'onHidden': $context.$data.onHiddenHandler, 'hideOnParentScroll': false }; } }; });
...
addToBindingsCache('visible: isSelected || isHovered, click: function(s, e) { e.stopPropagation(); }', function ($context, $element) { return { 'visible': function () { return $context.$data.isSelected || $context.$data.isHovered; }, 'click': function () { return function (s, e) { e.stopPropagation(); }; } }; });
addToBindingsCache('event: events, click: function(s, e) { $root.hideContextMenu && $root.hideContextMenu(); toggleSelected(s, e); }, styleunit: padding, draggable: isDraggable ? dragDropHandler : null, css: cssRules, attr: attr', function ($context, $element) { return { 'event': function () { return $context.$data.events; }, 'click': function () { return function (s, e) { $context.$root.hideContextMenu && $context.$root.hideContextMenu(); $context.$data.toggleSelected(s, e); }; }, 'styleunit': function () { return $context.$data.padding; }, 'draggable': function () { return $context.$data.isDraggable ? $context.$data.dragDropHandler : null; }, 'css': function () { return $context.$data.cssRules; }, 'attr': function () { return $context.$data.attr; } }; });
...
addToBindingsCache('event: events, click: toggleSelected,  draggable: isDraggable ? dragDropHandler : null, styleunit: padding, css: { \'dx-treelist-item-selected dxd-state-selected dxd-back-secondary\': isSelected || isMultiSelected }', function ($context, $element) { return { 'event': function () { return $context.$data.events; }, 'click': function () { return $context.$data.toggleSelected; }, 'draggable': function () { return $context.$data.isDraggable ? $context.$data.dragDropHandler : null; }, 'styleunit': function () { return $context.$data.padding; }, 'css': function () { return { 'dx-treelist-item-selected dxd-state-selected dxd-back-secondary': $context.$data.isSelected || $context.$data.isMultiSelected }; } }; });
