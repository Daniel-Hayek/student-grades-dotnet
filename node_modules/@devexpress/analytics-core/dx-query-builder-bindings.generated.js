/**
* DevExpress Analytics (dx-query-builder-bindings.generated.js)
* Version:  25.2.4
...
addToBindingsCache('dxAILoadingPanel: _currentPage().page._customLoadPanelViewModel($element, $data.isLoading)', function ($context, $element) { return { 'dxAILoadingPanel': function () { return $context.$data._currentPage().page._customLoadPanelViewModel($element, $context.$data.isLoading); } }; });
...
addToBindingsCache('if: !(_currentPage() && _currentPage().page._customLoadPanelViewModel)', function ($context, $element) { return { 'if': function () { return !($context.$data._currentPage() && $context.$data._currentPage().page._customLoadPanelViewModel); } }; });
addToBindingsCache('if: _currentPage() && _currentPage().page._customLoadPanelViewModel', function ($context, $element) { return { 'if': function () { return $context.$data._currentPage() && $context.$data._currentPage().page._customLoadPanelViewModel; } }; });
...
addToBindingsCache('dxButton: { icon: \'add\', onClick: _addCollection, disabled: _addQueryDisabled }', function ($context, $element) { return { 'dxButton': function () { return { 'icon': 'add', 'onClick': $context.$data._addCollection, 'disabled': $context.$data._addQueryDisabled }; } }; });
addToBindingsCache('dxDataGrid: _collectionsGrid', function ($context, $element) { return { 'dxDataGrid': function () { return $context.$data._collectionsGrid; } }; });
...
addToBindingsCache('dxEllipsisEditor: { value: value, buttonAction: buttonAction, disabled: disabled }', function ($context, $element) { return { 'dxEllipsisEditor': function () { return { 'value': $context.$data.value, 'buttonAction': $context.$data.buttonAction, 'disabled': $context.$data.disabled }; } }; });
addToBindingsCache('if: _filterEditorVisible', function ($context, $element) { return { 'if': function () { return $context.$data._filterEditorVisible; } }; });
addToBindingsCache('text: _querySelectBoxTitle', function ($context, $element) { return { 'text': function () { return $context.$data._querySelectBoxTitle; } }; });
addToBindingsCache('dxSelectBox: { dataSource: _availableQueries, value: _selectedQueryName, disabled: _isLoading, useItemTextAsTitle: true, dropDownOptions: { container: $root.getPopupContainer($element) } }', function ($context, $element) { return { 'dxSelectBox': function () { return { 'dataSource': $context.$data._availableQueries, 'value': $context.$data._selectedQueryName, 'disabled': $context.$data._isLoading, 'useItemTextAsTitle': true, 'dropDownOptions': { 'container': $context.$root.getPopupContainer($element) } }; } }; });
addToBindingsCache('if: _isLoading', function ($context, $element) { return { 'if': function () { return $context.$data._isLoading; } }; });
addToBindingsCache('ifnot: _isLoading', function ($context, $element) { return { 'ifnot': function () { return $context.$data._isLoading; } }; });
...
addToBindingsCache('css: { \'dxrd-disabled\': data.disabled }', function ($context, $element) { return { 'css': function () { return { 'dxrd-disabled': $context.$data.data.disabled }; } }; });
