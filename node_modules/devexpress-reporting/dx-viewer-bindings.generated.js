/**
* DevExpress HTML/JS Reporting (dx-viewer-bindings.generated.js)
* Version:  25.2.4
...
addToBindingsCache('dxDateBox: { type: \'time\', value: startRange.value, onValueChanged: startRange.onValueChanged }', function ($context, $element) { return { 'dxDateBox': function () { return { 'type': 'time', 'value': $context.$data.startRange.value, 'onValueChanged': $context.$data.startRange.onValueChanged }; } }; });
addToBindingsCache('dxDateBox: { type: \'time\', value: endRange.value, onValueChanged: endRange.onValueChanged }', function ($context, $element) { return { 'dxDateBox': function () { return { 'type': 'time', 'value': $context.$data.endRange.value, 'onValueChanged': $context.$data.endRange.onValueChanged }; } }; });
...
addToBindingsCache('dxLoadPanel: { visible: loading, position: { of: \'#\' + page_id } }', function ($context, $element) { return { 'dxLoadPanel': function () { return { 'visible': $context.$data.loading, 'position': { 'of': '#' + $context.$data.page_id } }; } }; });
addToBindingsCache('dxAILoadingPanel: getAILoadingPanelOptions()', function ($context, $element) { return { 'dxAILoadingPanel': function () { return $context.$data.getAILoadingPanelOptions(); } }; });
addToBindingsCache('attr: {\'aria-label\': currentPageAriaLabelImgAlt, \'id\': page_id }, dxclick: clickToBrick, \'brick-selection-prog\': brickSelectionProg', function ($context, $element) { return { 'attr': function () { return { 'aria-label': $context.$data.currentPageAriaLabelImgAlt, 'id': $context.$data.page_id }; }, 'dxclick': function () { return $context.$data.clickToBrick; }, 'brick-selection-prog': function () { return $context.$data.brickSelectionProg; } }; });
...
addToBindingsCache('text: translatedPageBadgeText', function ($context, $element) { return { 'text': function () { return $context.$data.translatedPageBadgeText; } }; });
...
addToBindingsCache('if: $data.aiOperationInProgress', function ($context, $element) { return { 'if': function () { return $context.$data.aiOperationInProgress; } }; });
...
addToBindingsCache('if: aiServicesEnabled && active', function ($context, $element) { return { 'if': function () { return $context.$data.aiServicesEnabled && $context.$data.active; } }; });
...
addToBindingsCache('if: aiServicesEnabled && !!aiCustomDocumentStorageId', function ($context, $element) { return { 'if': function () { return $context.$data.aiServicesEnabled && !!$context.$data.aiCustomDocumentStorageId; } }; });
...
addToBindingsCache('if: languageSelectBoxOptions.visible', function ($context, $element) { return { 'if': function () { return $context.$data.languageSelectBoxOptions.visible; } }; });
...
addToBindingsCache('css: { \'dxrd-visually-hidden\': !!currentPage || _aiOperationInProgress }', function ($context, $element) { return { 'css': function () { return { 'dxrd-visually-hidden': !!$context.$data.currentPage || $context.$data._aiOperationInProgress }; } }; });
...
addToBindingsCache('dxAILoadingPanel: _getAILoadingPanelOptions($element)', function ($context, $element) { return { 'dxAILoadingPanel': function () { return $context.$data._getAILoadingPanelOptions($element); } }; });
addToBindingsCache('dxPopup: { width: 450, height: 150, visible: _exportTranslatedDocPopupVisible, container: \'.dxrd-preview-surface\', target: \'.dxrd-preview-surface\', position: { at: \'center\', my: \'center\', collision: \'fit\', of: \'.dxrd-preview-surface\' }, dragEnabled: false, hideOnOutsideClick: true, showCloseButton: false, showTitle: false, onHiding: function(e) { onExportPopupHiding(); } }', function ($context, $element) { return { 'dxPopup': function () { return { 'width': 450, 'height': 150, 'visible': $context.$data._exportTranslatedDocPopupVisible, 'container': '.dxrd-preview-surface', 'target': '.dxrd-preview-surface', 'position': { 'at': 'center', 'my': 'center', 'collision': 'fit', 'of': '.dxrd-preview-surface' }, 'dragEnabled': false, 'hideOnOutsideClick': true, 'showCloseButton': false, 'showTitle': false, 'onHiding': function (e) { $context.$data.onExportPopupHiding(); } }; } }; });
addToBindingsCache('text: _exportTranslatedDodumentWarningMsg', function ($context, $element) { return { 'text': function () { return $context.$data._exportTranslatedDodumentWarningMsg; } }; });
addToBindingsCache('dxButton: { text: _exportTranslatedDocumentButtonText, onClick: _exportTranslatedHandler }', function ($context, $element) { return { 'dxButton': function () { return { 'text': $context.$data._exportTranslatedDocumentButtonText, 'onClick': $context.$data._exportTranslatedHandler }; } }; });
addToBindingsCache('dxButton: { text: _exportOriginalDocumentButtonText, onClick: _exportTranslatedCancel }', function ($context, $element) { return { 'dxButton': function () { return { 'text': $context.$data._exportOriginalDocumentButtonText, 'onClick': $context.$data._exportTranslatedCancel }; } }; });
...
addToBindingsCache('attr: predefinedDateRanges.attr, dxScrollView: predefinedDateRanges.scrollViewOptions, dxMutationObserver: predefinedDateRanges.accessibilityKeyboardHelper', function ($context, $element) { return { 'attr': function () { return $context.$data.predefinedDateRanges.attr; }, 'dxScrollView': function () { return $context.$data.predefinedDateRanges.scrollViewOptions; }, 'dxMutationObserver': function () { return $context.$data.predefinedDateRanges.accessibilityKeyboardHelper; } }; });
...
addToBindingsCache('dxPopup: getPopupSettings(true)', function ($context, $element) { return { 'dxPopup': function () { return $context.$data.getPopupSettings(true); } }; });
addToBindingsCache('dxBox: { direction: \'row\', width: \'450px\', height: 25, onItemClick: function(e) { $parent.onRangeItemClick(e); }, onItemRendered: function(e) { $parent.onRangeItemsRendered(e); }, items: $data.map(function(item) { return { ratio: item.ratio, template: item.template, click: item.click, selected: item.selected, id: item.id } }), }', function ($context, $element) { return { 'dxBox': function () { return { 'direction': 'row', 'width': '450px', 'height': 25, 'onItemClick': function (e) { $context.$parent.onRangeItemClick(e); }, 'onItemRendered': function (e) { $context.$parent.onRangeItemsRendered(e); }, 'items': $context.$data.map(function (item) { return { 'ratio': item.ratio, 'template': item.template, 'click': item.click, 'selected': item.selected, 'id': item.id }; }) }; } }; });
addToBindingsCache('dxBox: { direction: \'row\', width: \'450px\', height: 30 }', function ($context, $element) { return { 'dxBox': function () { return { 'direction': 'row', 'width': '450px', 'height': 30 }; } }; });
addToBindingsCache('text: $root.getLocalization(\'Start\', \'PreviewStringId.RangeParameters_Start\')', function ($context, $element) { return { 'text': function () { return $context.$root.getLocalization('Start', 'PreviewStringId.RangeParameters_Start'); } }; });
addToBindingsCache('dxDateBox: { type: \'time\', value: $parent.startRange.value, onValueChanged: $parent.startRange.onValueChanged, dropDownOptions: { container: $root.getPopupContainer($element) } }', function ($context, $element) { return { 'dxDateBox': function () { return { 'type': 'time', 'value': $context.$parent.startRange.value, 'onValueChanged': $context.$parent.startRange.onValueChanged, 'dropDownOptions': { 'container': $context.$root.getPopupContainer($element) } }; } }; });
addToBindingsCache('text: $root.getLocalization(\'End\', \'PreviewStringId.RangeParameters_End\')', function ($context, $element) { return { 'text': function () { return $context.$root.getLocalization('End', 'PreviewStringId.RangeParameters_End'); } }; });
addToBindingsCache('dxDateBox: { type: \'time\', value: $parent.endRange.value, onValueChanged: $parent.endRange.onValueChanged, dropDownOptions: { container: $root.getPopupContainer($element) } }', function ($context, $element) { return { 'dxDateBox': function () { return { 'type': 'time', 'value': $context.$parent.endRange.value, 'onValueChanged': $context.$parent.endRange.onValueChanged, 'dropDownOptions': { 'container': $context.$root.getPopupContainer($element) } }; } }; });
...
addToBindingsCache('foreach: predefinedDateRanges.items', function ($context, $element) { return { 'foreach': function () { return $context.$data.predefinedDateRanges.items; } }; });
addToBindingsCache('text: displayName', function ($context, $element) { return { 'text': function () { return $context.$data.displayName; } }; });
addToBindingsCache('foreach: predefinedDateRanges.groupedItems', function ($context, $element) { return { 'foreach': function () { return $context.$data.predefinedDateRanges.groupedItems; } }; });
addToBindingsCache('dxItem: { ratio: 1 }', function () { return { dxItem: { ratio: 1 } }; });
