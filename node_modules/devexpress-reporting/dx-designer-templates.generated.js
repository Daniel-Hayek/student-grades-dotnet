...
SvgTemplatesEngine.addTemplates({
    ...
    'dxrd-crossband-selection': '<div class="dxrd-cross-band" data-bind=" visible: isSelected() && !$root.dx._static.DragDropHandler.started(), css: {\'dxrd-selected dxrd-context-menu-container\': selected, \'dxrd-focused\': focused, \'dxrd-intersect\': isIntersect, \'dxrd-locked\': locked }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor"> </div> <div class="dxrd-crossband-selection-box dxrd-position-absolute" data-bind="visible: !isSelected(), styleunit: { left: rect().left, top: rect().top, width: 0, height: 0 }"> <div class="dxrd-crossband-selection-right dxrd-position-absolute" data-bind="styleunit: { left: rect().width - 5, top: -5, width: 10, height: rect().height + 10 }, trackCursor: selectionUnderCursor"></div> <div class="dxrd-crossband-selection-top dxrd-position-absolute" data-bind="styleunit: { left: -5, top: -5, width: rect().width + 10, height: 10 }, trackCursor: selectionUnderCursor"></div> <div class="dxrd-crossband-selection-left dxrd-position-absolute" data-bind="styleunit: { left: -5, top: -5, width: 10, height: rect().height + 10 }, trackCursor: selectionUnderCursor"></div> <div class="dxrd-crossband-selection-bottom dxrd-position-absolute" data-bind="styleunit: { left: -5, top: rect().height - 5, width: rect().width + 10, height: 10 }, trackCursor: selectionUnderCursor"></div> </div>',
    ...
    'dxrd-datasource-item': '<div class="dx-fieldset"> <div data-bind="dxCollectionEditor: { values: ko.observable(tableInfoItems), displayName: $root.getLocalization(\'Filter Criteria\', \'ASPxReportsStringId.ReportDesigner_DataSource_FilterCriteriaTitle\'), hideButtons: true }"> <div class="dx-field dxd-back-primary"> <!-- ko with: value --> <div class="dx-field-label dxd-text-primary" data-bind="text: tableName"></div> <!-- ko if: $data.filterString() !== null --> <div class="dx-field-value dxrd-margin-right-5px"  data-bind="dxFilterEditor: { options: filterString, fieldListProvider: $root.dataBindingsProvider, getDisplayNameByPath: $root.getDisplayNameByPath, aiExpressionGenerator: $root.aiExpressionGenerator }"></div> <!-- /ko --> <!-- /ko --> </div> </div></div>',
    'dxrd-aipanelwrapper': '<div class="dxrd-properties-wrapper dxrd-height-100 dxrd-overflow-hidden dxrd-aipanel" data-bind="visible: active && visible" > <!-- ko if: model.visible --> <div class="dxrd-right-panel-header dxd-text-primary"> <div class="dxrd-right-panel-floating-header" data-bind="text: text"></div> <!-- ko with: model --> <!-- ko if: fakePreviewButtonVisible --> <div class="dxrd-right-panel-header-button" data-bind="dxButtonWithTemplate: { onClick: showPreviewWithFakeData, text: fakePreviewButtonText, icon: \'dxrd-svg-operations-ai\', iconClass: \'dx-image-ai\' }, attr: { title: fakePreviewButtonTitle }"> </div> <!-- /ko --> <!-- /ko --> </div> <div class="dxrd-properties-grid dxd-border-primary dxrd-top-80px" data-bind="dxScrollView: { showScrollbar: \'onHover\', useNative: false, scrollByThumb: true }" > </div> <!-- /ko --></div>',
    ...
    'dx-treelist-action-container-with-rename': '<div class="dx-treelist-action-container" data-bind="visible: !inRenameMode && (isSelected || isHovered), click: function(s, e) { e.stopPropagation(); }"> <!-- ko template: actionsTemplate --> <!-- /ko --> </div>',
    ...
    'dxrd-parameters-dialog': '<div data-bind="css: \'dxrd-reportdialog dxrd-parameters-dialog dx-editors dx-widget \' + popupCss, dxPopup: { wrapperAttr: { class: \'dxrd-reportdialog dxrd-parameters-dialog dx-editors dx-widget \' + popupCss }, showTitle: true, width: \'85%\', height: \'85%\', maxWidth: maxWidth, maxHeight: maxHeight, title: $root.getLocalization(title), visible: visible, toolbarItems: buttons, showCloseButton: true, fullScreen: false, container: container($element), position: { of: container($element) }}"> <div class="dxrd-parameters-popup-content"> <!-- ko template: contentTemplate --> <!-- /ko --> </div></div>',
    ...
    'dxrd-parameter-edit': '<div data-bind="dxScrollView: { showScrollbar: \'onHover\' }"> <div class="dxrd-parameter-edit-content"> <div class="dxrd-parameter-edit-content-grid dxrd-parameters-properties" data-bind="template: { name: \'dx-propertieseditor\', data: _propertiesGrid }"></div> <!-- ko if: _selectedParameterSettings --> <div class="dxrd-parameter-edit-content-grid dxrd-parameters-settings" data-bind="template: { name: \'dx-propertieseditor\', data: _settingsGrid }"></div> <!-- /ko --> </div> </div>',
    ...
    'dxrd-toolbar-two-way-switch-clickable': '<div role="button" data-bind="class: \'dx-accessibility-toolbar-item dx-accessibility-focus-border-accented dxd-border-primary dxd-back-highlighted \' + (ko.unwrap($data.imageTemplateName) && \'dxrd-switch-button-with-icon\' || \'\'), visible: $data.visible, attr: { \'aria-label\': $data.displayText && $data.displayText() || $data.text, \'aria-disabled\': ko.unwrap($data.disabled) ? \'true\' : \'false\', \'aria-pressed\': $data.selected ? ($data.selected() ? \'true\' : \'false\') : null }" > <!-- ko ifnot: $data.imageTemplateName --> <div data-bind="text: $data.displayText && $data.displayText() || $data.text, attr: { title: $data.displayText && $data.displayText() || $data.text, class: \'dxd-text-primary \' + (ko.unwrap($data.imageClassName) || \'\') }, dxclick: function() { if((typeof $data.disabled === \'function\') && !$data.disabled() || !$data.disabled) { $data.clickAction($root.model && $root.model()); } }, css: {\'dxrd-disabled-button\': $data.disabled }"></div> <!-- /ko --> <!-- ko if: $data.imageTemplateName --> <div data-bind="attr: { title: $data.displayText && $data.displayText() || $data.text, class: \'dxd-text-primary dxrd-switch-icon \' + (ko.unwrap($data.imageClassName) || \'\') }, dxclick: function() { if((typeof $data.disabled === \'function\') && !$data.disabled() || !$data.disabled) { $data.clickAction($root.model && $root.model()); } }, css: {\'dxrd-disabled-button\': $data.disabled }"> <!-- ko template: { name: $data.imageTemplateName } --> <!-- /ko --> <!-- ko text: $data.text --> <!-- /ko --> </div> <!-- /ko --> </div>',
    ...
    'dxrd-pivotcriteria': '<!-- ko with: $data.wrapModel($root.fieldListProvider) --> <div data-bind="dxFilterEditor: { options: value, fieldListProvider: itemsProvider, getDisplayNameByPath: $root.getDisplayNameByPath, displayNameProvider: displayNameProvider, aiExpressionGenerator: $root.aiExpressionGenerator }"></div> <!-- /ko -->',
    ...
    'dxrd-page-crosstab-setlayout': '<div class="dxrd-wizard-page dxrd-wizard-crosstab-setlayout-page" data-bind="trackCursor: underCursor, css: {\'dxrd-wizard-crosstab-droppable-page\': isDroppable}"> <div class="dxrd-wizard-list-container"> <div class="dxrd-wizard-list dx-default-border-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: \'onHover\', height: \'100%\' }"> <div class="dxrd-wizard-field-infos dxrd-wizard-field-infos-title dxd-border-secondary dxd-back-contrast"> <div class="dxrd-wizard-field-infos-title-image" data-bind="template: _icon"></div> <div class="dxrd-wizard-field-infos-title-content dxd-text-primary" data-bind="text: _title"></div> </div> <div class="dxrd-wizard-field-infos dxrd-wizard-field-infos-paragraf dxd-border-secondary"> <div class="dxrd-wizard-field-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: _fieldName"></div> <div class="dxrd-wizard-field-infos-values dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: _valueName"></div> <div class="dxrd-wizard-field-infos-removebtn dxd-wizard-title-back-color dxd-back-secondary"></div> </div> <div data-bind="foreach: fieldInfos"> <div class="dxrd-wizard-field-infos dxd-border-secondary"> <div class="dxrd-wizard-field-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary"> <div data-bind="dxSelectBox: { dataSource: $parent._crossTabFields, displayExpr: \'displayName\', value: field, placeholder: $root.dx._static.selectPlaceholder(), dropDownOptions: { container: $root.getPopupContainer($element) }, useItemTextAsTitle: true  }"></div> </div> <div class="dxrd-wizard-field-infos-values dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary"> <div data-bind="dxSelectBox: { dataSource: value.dataSource, displayExpr: value.displayExpr, placeholder: value.placeholder, selectAllText: value.selectAllText, selectedItems: value.selectedItems, showDropDownButton: value.showDropDownButton, value: value.value, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div> </div> <div class="dxrd-wizard-field-infos-removebtn dxd-wizard-title-back-color dxd-back-secondary"> <div data-bind="dxButton: { icon: \'close\', onClick: function () { return $parent._removeInfo($data);  }}"></div> </div> </div> </div> </div> </div> </div>',
    'dxrd-page-ai-report-layout': '<div class="dxrd-wizard-type-page dxrd-page-ai-report-layout"> <!-- ko if: _showDataStructure --> <div class="dxrd-ai-layout-section dxrd-ai-data-structure"> <div class="dxrd-ai-layout-section-title" data-bind="text: _dataStructureSectionTitle"></div> <div class="dxrd-ai-layout-section-content dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: \'onHover\', height: \'auto\' }"> <div data-bind="treelist: _fieldListModel"></div> </div> </div> <!-- /ko --> <div class="dxrd-ai-layout-section dxrd-ai-report-prompt"> <div class="dxrd-ai-layout-section-title" data-bind="text: _promptSectionTitle"></div> <div class="dxrd-ai-layout-section-content dxd-border-secondary" data-bind="dxTextArea: _getPromptTextAreaOptions()"></div> </div> <div class="dxrd-ai-layout-section dxrd-ai-report-prompt-suggestions"> <div class="dxrd-ai-layout-section-title" data-bind="text: _suggestionsSectionTitle"></div> <div class="dxrd-ai-layout-section-content dxd-border-secondary" data-bind="dxList: _getSuggentionListOptions()"></div> </div> </div>',
    ...
    'dxrd-page-masterdetail-select-reportdata-dataMembers': '<div class="dxrd-wizard-reportdata-column dx-first-column"> <div class="dxrd-wizard-reportdata-title" data-bind="text: _selectDataMembersCaption"></div> <div class="dxrd-wizard-queries-search" data-bind="treeListSearchPanel: {controllers: ko.unwrap(_dataMemberFieldListModel).treeListController}"></div> <div class="drx-wizard-queires-container"> <div class="dxrd-wizard-add-queries-page dxrd-wizard-masterdetail-dataMember dxrd-wizard-page-treelist-accordion-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: \'onHover\', height: \'auto\' }"> <div data-bind="treelist: _dataMemberFieldListModel" class="dxrd-width-100 dxrd-height-100"></div> </div> </div> </div>',
    'dxrd-page-masterdetail-select-reportdata-fieldMembers': '<div class="dxrd-wizard-reportdata-column"> <div class="dxrd-wizard-reportdata-title" data-bind="text: _selectDataFieldsCaption"></div> <div class="dxrd-wizard-queries-search" data-bind="treeListSearchPanel: {controllers: ko.unwrap(_fieldMemberFieldListModel).treeListController}"></div> <div class="drx-wizard-queires-container"> <div class="dxrd-wizard-add-queries-page dxrd-wizard-masterdetail-fields dxrd-wizard-page-treelist-accordion-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: \'onHover\', height: \'auto\' }"> <div data-bind="treelist: _fieldMemberFieldListModel" class="dxrd-width-100 dxrd-height-100"></div> </div> </div> </div>',
