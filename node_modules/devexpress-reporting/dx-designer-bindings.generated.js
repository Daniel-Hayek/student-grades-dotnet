/**
* DevExpress HTML/JS Reporting (dx-designer-bindings.generated.js)
* Version:  25.2.4
...
addToBindingsCache('css: {\'dxcd-summaryfunction-arg\': $parents[1].actionsAreAvailable }', function ($context, $element) { return { 'css': function () { return { 'dxcd-summaryfunction-arg': $context.$parents[1].actionsAreAvailable }; } }; });
...
addToBindingsCache('dxCollectionEditor: { values: value, displayName: displayName, level: level, info: info, addHandler: function() { return addPoint(); } }', function ($context, $element) { return { 'dxCollectionEditor': function () { return { 'values': $context.$data.value, 'displayName': $context.$data.displayName, 'level': $context.$data.level, 'info': $context.$data.info, 'addHandler': function () { return $context.$data.addPoint(); } }; } }; });
...
addToBindingsCache('dragDropFileToControl:{ dragDropHandler: $root.toolboxDragHandler, dragDropFileEnabled: dragDropFileEnabled}, event: { dblclick: function() { $root.inlineTextEdit.show($element) } }, style: { visibility: (selected() || focused()) ? \'inherit\' : \'hidden\'}, css: {\'dxrd-selected dxrd-context-menu-container\': selected, \'dxrd-focused\': focused, \'dxrd-intersect\': isIntersect, \'dxrd-locked\': locked, \'dxrd-drop-zone-border\': showDropBorders }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor', function ($context, $element) { return { 'dragDropFileToControl': function () { return { 'dragDropHandler': $context.$root.toolboxDragHandler, 'dragDropFileEnabled': $context.$data.dragDropFileEnabled }; }, 'event': function () { return { 'dblclick': function () { $context.$root.inlineTextEdit.show($element); } }; }, 'style': function () { return { 'visibility': ($context.$data.selected() || $context.$data.focused()) ? 'inherit' : 'hidden' }; }, 'css': function () { return { 'dxrd-selected dxrd-context-menu-container': $context.$data.selected, 'dxrd-focused': $context.$data.focused, 'dxrd-intersect': $context.$data.isIntersect, 'dxrd-locked': $context.$data.locked, 'dxrd-drop-zone-border': $context.$data.showDropBorders }; }, 'resizable': function () { return $context.$root.resizeHandler; }, 'draggable': function () { return $context.$root.dragHandler; }, 'styleunit': function () { return $context.$data.position; }, 'trackCursor': function () { return $context.$data.underCursor; } }; });
...
addToBindingsCache('dragDropFileToControl: { dragDropHandler: $root.toolboxDragHandler, dragDropFileEnabled: dragDropFileEnabled}, visible: !(selected() && focused()), styleunit: position, trackCursor: underCursor, style:{ overflow: isSelected() ? \'visible\' : \'hidden\'}, css: {\'dxrd-drop-zone-border\': showDropBorders }', function ($context, $element) { return { 'dragDropFileToControl': function () { return { 'dragDropHandler': $context.$root.toolboxDragHandler, 'dragDropFileEnabled': $context.$data.dragDropFileEnabled }; }, 'visible': function () { return !($context.$data.selected() && $context.$data.focused()); }, 'styleunit': function () { return $context.$data.position; }, 'trackCursor': function () { return $context.$data.underCursor; }, 'style': function () { return { 'overflow': $context.$data.isSelected() ? 'visible' : 'hidden' }; }, 'css': function () { return { 'dxrd-drop-zone-border': $context.$data.showDropBorders }; } }; });
...
addToBindingsCache('visible: !isSelected(), styleunit: { left: rect().left, top: rect().top, width: 0, height: 0 }', function ($context, $element) { return { 'visible': function () { return !$context.$data.isSelected(); }, 'styleunit': function () { return { 'left': $context.$data.rect().left, 'top': $context.$data.rect().top, 'width': 0, 'height': 0 }; } }; });
addToBindingsCache('styleunit: { left: rect().width - 5, top: -5, width: 10, height: rect().height + 10 }, trackCursor: selectionUnderCursor', function ($context, $element) { return { 'styleunit': function () { return { 'left': $context.$data.rect().width - 5, 'top': -5, 'width': 10, 'height': $context.$data.rect().height + 10 }; }, 'trackCursor': function () { return $context.$data.selectionUnderCursor; } }; });
addToBindingsCache('styleunit: { left: -5, top: -5, width: rect().width + 10, height: 10 }, trackCursor: selectionUnderCursor', function ($context, $element) { return { 'styleunit': function () { return { 'left': -5, 'top': -5, 'width': $context.$data.rect().width + 10, 'height': 10 }; }, 'trackCursor': function () { return $context.$data.selectionUnderCursor; } }; });
addToBindingsCache('styleunit: { left: -5, top: -5, width: 10, height: rect().height + 10 }, trackCursor: selectionUnderCursor', function ($context, $element) { return { 'styleunit': function () { return { 'left': -5, 'top': -5, 'width': 10, 'height': $context.$data.rect().height + 10 }; }, 'trackCursor': function () { return $context.$data.selectionUnderCursor; } }; });
addToBindingsCache('styleunit: { left: -5, top: rect().height - 5, width: rect().width + 10, height: 10 }, trackCursor: selectionUnderCursor', function ($context, $element) { return { 'styleunit': function () { return { 'left': -5, 'top': $context.$data.rect().height - 5, 'width': $context.$data.rect().width + 10, 'height': 10 }; }, 'trackCursor': function () { return $context.$data.selectionUnderCursor; } }; });
...
addToBindingsCache('dragDropFileToControl:{ dragDropHandler: $root.toolboxDragHandler, dragDropFileEnabled: dragDropFileEnabled}, style: { visibility: (selected() || focused()) ? \'inherit\' : \'hidden\'}, css: {\'dxrd-selected dxrd-context-menu-container\': selected, \'dxrd-focused\': focused, \'dxrd-intersect\': isIntersect, \'dxrd-locked\': locked, \'dxrd-drop-zone-border\': showDropBorders }, resizable: $data.getResizableOptions($root.resizeHandler), draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor', function ($context, $element) { return { 'dragDropFileToControl': function () { return { 'dragDropHandler': $context.$root.toolboxDragHandler, 'dragDropFileEnabled': $context.$data.dragDropFileEnabled }; }, 'style': function () { return { 'visibility': ($context.$data.selected() || $context.$data.focused()) ? 'inherit' : 'hidden' }; }, 'css': function () { return { 'dxrd-selected dxrd-context-menu-container': $context.$data.selected, 'dxrd-focused': $context.$data.focused, 'dxrd-intersect': $context.$data.isIntersect, 'dxrd-locked': $context.$data.locked, 'dxrd-drop-zone-border': $context.$data.showDropBorders }; }, 'resizable': function () { return $context.$data.getResizableOptions($context.$root.resizeHandler); }, 'draggable': function () { return $context.$root.dragHandler; }, 'styleunit': function () { return $context.$data.position; }, 'trackCursor': function () { return $context.$data.underCursor; } }; });
addToBindingsCache('dragDropFileToControl: { dragDropHandler: $root.toolboxDragHandler, dragDropFileEnabled: dragDropFileEnabled}, visible: !(selected() && focused()), styleunit: position, trackCursor: underCursor, style:{ overflow: isSelected() ? \'visible\' : \'hidden\'}, css:{ \'dxrd-drop-zone-border\': showDropBorders}', function ($context, $element) { return { 'dragDropFileToControl': function () { return { 'dragDropHandler': $context.$root.toolboxDragHandler, 'dragDropFileEnabled': $context.$data.dragDropFileEnabled }; }, 'visible': function () { return !($context.$data.selected() && $context.$data.focused()); }, 'styleunit': function () { return $context.$data.position; }, 'trackCursor': function () { return $context.$data.underCursor; }, 'style': function () { return { 'overflow': $context.$data.isSelected() ? 'visible' : 'hidden' }; }, 'css': function () { return { 'dxrd-drop-zone-border': $context.$data.showDropBorders }; } }; });
...
addToBindingsCache('controlDisplayName: $data, style: contentCss, css: { \'dxrd-control-content-multiline\' : multiline }', function ($context, $element) { return { 'controlDisplayName': function () { return $context.$data; }, 'style': function () { return $context.$data.contentCss; }, 'css': function () { return { 'dxrd-control-content-multiline': $context.$data.multiline }; } }; });
addToBindingsCache('dragDropFileToControl: { dragDropHandler: $root.toolboxDragHandler, dragDropFileEnabled: dragDropFileEnabled}, visible: selected() || focused(), css: {\'dxrd-selected dxrd-context-menu-container\': selected, \'dxrd-focused\': focused, \'dxrd-intersect\': isIntersect, \'dxrd-locked\': locked, \'dxrd-drop-zone-border\': showDropBorders }, resizable: $data.getResizeOptions($root.resizeHandler), draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor', function ($context, $element) { return { 'dragDropFileToControl': function () { return { 'dragDropHandler': $context.$root.toolboxDragHandler, 'dragDropFileEnabled': $context.$data.dragDropFileEnabled }; }, 'visible': function () { return $context.$data.selected() || $context.$data.focused(); }, 'css': function () { return { 'dxrd-selected dxrd-context-menu-container': $context.$data.selected, 'dxrd-focused': $context.$data.focused, 'dxrd-intersect': $context.$data.isIntersect, 'dxrd-locked': $context.$data.locked, 'dxrd-drop-zone-border': $context.$data.showDropBorders }; }, 'resizable': function () { return $context.$data.getResizeOptions($context.$root.resizeHandler); }, 'draggable': function () { return $context.$root.dragHandler; }, 'styleunit': function () { return $context.$data.position; }, 'trackCursor': function () { return $context.$data.underCursor; } }; });
...
addToBindingsCache('template: { name: \'dxrd-crossband-selection\' }', function ($context, $element) { return { 'template': function () { return { 'name': 'dxrd-crossband-selection' }; } }; });
...
addToBindingsCache('dxFilterEditor: { options: filterString, fieldListProvider: $root.dataBindingsProvider, getDisplayNameByPath: $root.getDisplayNameByPath, aiExpressionGenerator: $root.aiExpressionGenerator }', function ($context, $element) { return { 'dxFilterEditor': function () { return { 'options': $context.$data.filterString, 'fieldListProvider': $context.$root.dataBindingsProvider, 'getDisplayNameByPath': $context.$root.getDisplayNameByPath, 'aiExpressionGenerator': $context.$root.aiExpressionGenerator }; } }; });
...
addToBindingsCache('dxButtonWithTemplate: { onClick: showPreviewWithFakeData, text: fakePreviewButtonText, icon: \'dxrd-svg-operations-ai\', iconClass: \'dx-image-ai\' }, attr: { title: fakePreviewButtonTitle }', function ($context, $element) { return { 'dxButtonWithTemplate': function () { return { 'onClick': $context.$data.showPreviewWithFakeData, 'text': $context.$data.fakePreviewButtonText, 'icon': 'dxrd-svg-operations-ai', 'iconClass': 'dx-image-ai' }; }, 'attr': function () { return { 'title': $context.$data.fakePreviewButtonTitle }; } }; });
...
addToBindingsCache('if: model.visible', function ($context, $element) { return { 'if': function () { return $context.$data.model.visible; } }; });
addToBindingsCache('with: model', function ($context, $element) { return { 'with': function () { return $context.$data.model; } }; });
addToBindingsCache('if: fakePreviewButtonVisible', function ($context, $element) { return { 'if': function () { return $context.$data.fakePreviewButtonVisible; } }; });
...
addToBindingsCache('visible: !inRenameMode && (isSelected || isHovered), click: function(s, e) { e.stopPropagation(); }', function ($context, $element) { return { 'visible': function () { return !$context.$data.inRenameMode && ($context.$data.isSelected || $context.$data.isHovered); }, 'click': function () { return function (s, e) { e.stopPropagation(); }; } }; });
...
addToBindingsCache('dxButtonWithTemplate: { onClick: function() { $data.applyLocalization(); }, disabled: isDisabled(), icon: icon, iconClass: iconClass }, attr: { title: $root.getLocalization(\'Localize with AI\', \'ASPxReportsStringId.ReportDesigner_LocalizationEditorTranslate\') }', function ($context, $element) { return { 'dxButtonWithTemplate': function () { return { 'onClick': function () { $context.$data.applyLocalization(); }, 'disabled': $context.$data.isDisabled(), 'icon': $context.$data.icon, 'iconClass': $context.$data.iconClass }; }, 'attr': function () { return { 'title': $context.$root.getLocalization('Localize with AI', 'ASPxReportsStringId.ReportDesigner_LocalizationEditorTranslate') }; } }; });
...
addToBindingsCache('dxAILoadingPanel: getLoadPanelOptions($element)', function ($context, $element) { return { 'dxAILoadingPanel': function () { return $context.$data.getLoadPanelOptions($element); } }; });
...
addToBindingsCache('if: hasRegisteredService()', function ($context, $element) { return { 'if': function () { return $context.$data.hasRegisteredService(); } }; });
addToBindingsCache('with: getRegisteredService()', function ($context, $element) { return { 'with': function () { return $context.$data.getRegisteredService(); } }; });
...
addToBindingsCache('template: { name: $parent.getIconTemplateByErrorCategory($data.data) }, attr: { title: $parent.getTitleByErrorType($data.value) }', function ($context, $element) { return { 'template': function () { return { 'name': $context.$parent.getIconTemplateByErrorCategory($context.$data.data) }; }, 'attr': function () { return { 'title': $context.$parent.getTitleByErrorType($context.$data.value) }; } }; });
...
addToBindingsCache('css: \'dxrd-reportdialog dxrd-parameters-dialog dx-editors dx-widget \' + popupCss, dxPopup: { wrapperAttr: { class: \'dxrd-reportdialog dxrd-parameters-dialog dx-editors dx-widget \' + popupCss }, showTitle: true, width: \'85%\', height: \'85%\', maxWidth: maxWidth, maxHeight: maxHeight, title: $root.getLocalization(title), visible: visible, toolbarItems: buttons, showCloseButton: true, fullScreen: false, container: container($element), position: { of: container($element) }}', function ($context, $element) { return { 'css': function () { return 'dxrd-reportdialog dxrd-parameters-dialog dx-editors dx-widget ' + $context.$data.popupCss; }, 'dxPopup': function () { return { 'wrapperAttr': { 'class': 'dxrd-reportdialog dxrd-parameters-dialog dx-editors dx-widget ' + $context.$data.popupCss }, 'showTitle': true, 'width': '85%', 'height': '85%', 'maxWidth': $context.$data.maxWidth, 'maxHeight': $context.$data.maxHeight, 'title': $context.$root.getLocalization($context.$data.title), 'visible': $context.$data.visible, 'toolbarItems': $context.$data.buttons, 'showCloseButton': true, 'fullScreen': false, 'container': $context.$data.container($element), 'position': { 'of': $context.$data.container($element) } }; } }; });
...
addToBindingsCache('css: { \'dx-field-flex dxrd-display-flex\': (templateName === \'dx-boolean\'), \'dx-field-block dxrd-display-block\': (templateName !== \'dx-boolean\') }', function ($context, $element) { return { 'css': function () { return { 'dx-field-flex dxrd-display-flex': ($context.$data.templateName === 'dx-boolean'), 'dx-field-block dxrd-display-block': ($context.$data.templateName !== 'dx-boolean') }; } }; });
...
addToBindingsCache('class: \'dx-accessibility-toolbar-item dx-accessibility-focus-border-accented dxd-border-primary dxd-back-highlighted \' + (ko.unwrap($data.imageTemplateName) && \'dxrd-switch-button-with-icon\' || \'\'), visible: $data.visible, attr: { \'aria-label\': $data.displayText && $data.displayText() || $data.text, \'aria-disabled\': ko.unwrap($data.disabled) ? \'true\' : \'false\', \'aria-pressed\': $data.selected ? ($data.selected() ? \'true\' : \'false\') : null }', function ($context, $element) { return { 'class': function () { return 'dx-accessibility-toolbar-item dx-accessibility-focus-border-accented dxd-border-primary dxd-back-highlighted ' + ($context.ko.unwrap($context.$data.imageTemplateName) && 'dxrd-switch-button-with-icon' || ''); }, 'visible': function () { return $context.$data.visible; }, 'attr': function () { return { 'aria-label': $context.$data.displayText && $context.$data.displayText() || $context.$data.text, 'aria-disabled': $context.ko.unwrap($context.$data.disabled) ? 'true' : 'false', 'aria-pressed': $context.$data.selected ? ($context.$data.selected() ? 'true' : 'false') : null }; } }; });
addToBindingsCache('text: $data.displayText && $data.displayText() || $data.text, attr: { title: $data.displayText && $data.displayText() || $data.text, class: \'dxd-text-primary \' + (ko.unwrap($data.imageClassName) || \'\') }, dxclick: function() { if((typeof $data.disabled === \'function\') && !$data.disabled() || !$data.disabled) { $data.clickAction($root.model && $root.model()); } }, css: {\'dxrd-disabled-button\': $data.disabled }', function ($context, $element) { return { 'text': function () { return $context.$data.displayText && $context.$data.displayText() || $context.$data.text; }, 'attr': function () { return { 'title': $context.$data.displayText && $context.$data.displayText() || $context.$data.text, 'class': 'dxd-text-primary ' + ($context.ko.unwrap($context.$data.imageClassName) || '') }; }, 'dxclick': function () { return function () { if ((typeof $context.$data.disabled === 'function') && !$context.$data.disabled() || !$context.$data.disabled) {
...
addToBindingsCache('attr: { title: $data.displayText && $data.displayText() || $data.text, class: \'dxd-text-primary dxrd-switch-icon \' + (ko.unwrap($data.imageClassName) || \'\') }, dxclick: function() { if((typeof $data.disabled === \'function\') && !$data.disabled() || !$data.disabled) { $data.clickAction($root.model && $root.model()); } }, css: {\'dxrd-disabled-button\': $data.disabled }', function ($context, $element) { return { 'attr': function () { return { 'title': $context.$data.displayText && $context.$data.displayText() || $context.$data.text, 'class': 'dxd-text-primary dxrd-switch-icon ' + ($context.ko.unwrap($context.$data.imageClassName) || '') }; }, 'dxclick': function () { return function () { if ((typeof $context.$data.disabled === 'function') && !$context.$data.disabled() || !$context.$data.disabled) {
        $context.$data.clickAction($context.$root.model && $context.$root.model());
    } }; }, 'css': function () { return { 'dxrd-disabled-button': $context.$data.disabled }; } }; });
...
addToBindingsCache('ifnot: $data.imageTemplateName', function ($context, $element) { return { 'ifnot': function () { return $context.$data.imageTemplateName; } }; });
addToBindingsCache('text: $data.text', function ($context, $element) { return { 'text': function () { return $context.$data.text; } }; });
...
addToBindingsCache('dxFilterEditor: { options: value, fieldListProvider: itemsProvider, getDisplayNameByPath: $root.getDisplayNameByPath, displayNameProvider: displayNameProvider, aiExpressionGenerator: $root.aiExpressionGenerator }', function ($context, $element) { return { 'dxFilterEditor': function () { return { 'options': $context.$data.value, 'fieldListProvider': $context.$data.itemsProvider, 'getDisplayNameByPath': $context.$root.getDisplayNameByPath, 'displayNameProvider': $context.$data.displayNameProvider, 'aiExpressionGenerator': $context.$root.aiExpressionGenerator }; } }; });
...
addToBindingsCache('dxTagBox: { dataSource: getValues(), value: editorValue, valueExpr: \'value\', displayExpr: \'displayValue\', disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) }, useItemTextAsTitle: true, multiline: false, showSelectionControls: true, showDropDownButton: true, selectAllText: selectAllText, maxDisplayedTags: maxDisplayedTags, onMultiTagPreparing: onMultiTagPreparing, }', function ($context, $element) { return { 'dxTagBox': function () { return { 'dataSource': $context.$data.getValues(), 'value': $context.$data.editorValue, 'valueExpr': 'value', 'displayExpr': 'displayValue', 'disabled': $context.$data.disabled, 'dropDownOptions': { 'container': $context.$root.getPopupContainer($element) }, 'useItemTextAsTitle': true, 'multiline': false, 'showSelectionControls': true, 'showDropDownButton': true, 'selectAllText': $context.$data.selectAllText, 'maxDisplayedTags': $context.$data.maxDisplayedTags, 'onMultiTagPreparing': $context.$data.onMultiTagPreparing }; } }; });
...
addToBindingsCache('dxSelectBox: { dataSource: value.dataSource, displayExpr: value.displayExpr, placeholder: value.placeholder, selectAllText: value.selectAllText, selectedItems: value.selectedItems, showDropDownButton: value.showDropDownButton, value: value.value, dropDownOptions: { container: $root.getPopupContainer($element) } }', function ($context, $element) { return { 'dxSelectBox': function () { return { 'dataSource': $context.$data.value.dataSource, 'displayExpr': $context.$data.value.displayExpr, 'placeholder': $context.$data.value.placeholder, 'selectAllText': $context.$data.value.selectAllText, 'selectedItems': $context.$data.value.selectedItems, 'showDropDownButton': $context.$data.value.showDropDownButton, 'value': $context.$data.value.value, 'dropDownOptions': { 'container': $context.$root.getPopupContainer($element) } }; } }; });
...
addToBindingsCache('text: _dataStructureSectionTitle', function ($context, $element) { return { 'text': function () { return $context.$data._dataStructureSectionTitle; } }; });
...
addToBindingsCache('text: _promptSectionTitle', function ($context, $element) { return { 'text': function () { return $context.$data._promptSectionTitle; } }; });
addToBindingsCache('dxTextArea: _getPromptTextAreaOptions()', function ($context, $element) { return { 'dxTextArea': function () { return $context.$data._getPromptTextAreaOptions(); } }; });
addToBindingsCache('text: _suggestionsSectionTitle', function ($context, $element) { return { 'text': function () { return $context.$data._suggestionsSectionTitle; } }; });
addToBindingsCache('dxList: _getSuggentionListOptions()', function ($context, $element) { return { 'dxList': function () { return $context.$data._getSuggentionListOptions(); } }; });
addToBindingsCache('if: _showDataStructure', function ($context, $element) { return { 'if': function () { return $context.$data._showDataStructure; } }; });
...
addToBindingsCache('treeListSearchPanel: {controllers: ko.unwrap(_dataMemberFieldListModel).treeListController}', function ($context, $element) { return { 'treeListSearchPanel': function () { return { 'controllers': $context.ko.unwrap($context.$data._dataMemberFieldListModel).treeListController }; } }; });
...
addToBindingsCache('treeListSearchPanel: {controllers: ko.unwrap(_fieldMemberFieldListModel).treeListController}', function ($context, $element) { return { 'treeListSearchPanel': function () { return { 'controllers': $context.ko.unwrap($context.$data._fieldMemberFieldListModel).treeListController }; } }; });
...
addToBindingsCache('dxSelectBox: { items: lookupData.reportUnit, valueExpr: \'value\', displayExpr: \'displayName\', value: reportUnit, dropDownOptions: { container: $root.getPopupContainer($element) }, useItemTextAsTitle: true  }', function ($context, $element) { return { 'dxSelectBox': function () { return { 'items': $context.$data.lookupData.reportUnit, 'valueExpr': 'value', 'displayExpr': 'displayName', 'value': $context.$data.reportUnit, 'dropDownOptions': { 'container': $context.$root.getPopupContainer($element) }, 'useItemTextAsTitle': true }; } }; });
