...
export class EditingField extends BaseRenderingModel {
    ...
    createModel(page, pageWidth, pageHeight, editingFieldsProvider, bounds) {
        if (this._fieldModel.type === 'check') {
            ...
            return new TextEditingFieldViewModel(this, pageWidth, pageHeight, page);
        }
        else if (this._fieldModel.type === 'charactercomb') {
            return new CharacterCombEditingFieldViewModel(this, pageWidth, pageHeight, page);
        }
        else if (this._fieldModel.type === 'image') {
            return new DefaultImageEditingFieldViewModel(this, pageWidth, pageHeight, page);
        }
    }
}
__decorate([
