...
export class TextEditingFieldViewModel extends TextEditingFieldViewModelBase {
    constructor(field, pageWidth, pageHeight, page) {
        ...
        this.textStyle = extend({}, cssCalculator.fontCss(), cssCalculator.foreColorCss(), cssCalculator.textAlignmentCss(), cssCalculator.lineSpacingCss());
        this.field = field;
        if (brickStyle.wordWrap != undefined) {
            this.wordWrap = brickStyle.wordWrap;
        }
        if (brickStyle.lineSpacing) {
            const lineSpacingCss = cssCalculator.createLineSpacing(brickStyle.lineSpacing);
            extend(this.textStyle, lineSpacingCss);
        }
