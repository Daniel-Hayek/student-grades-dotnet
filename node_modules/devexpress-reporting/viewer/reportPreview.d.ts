...
export declare class ReportPreview extends ReportHolder {
    ...
    _show(initializeDataPromise: DxPromise<IPreviewInitialize>, isAIOperation?: boolean): void;
    ...
    customDocumentOperation(customData?: string, hideMessageFromUser?: boolean): DxPromise<IDocumentOperationResult>;
