...
export function createPreviewPageViewModel(base) {
    return createViewModelGenerator(base)
        ...
        .generateProperty('imageSrc', this.imageSrc)
        ...
        .generateProperty('revertToOriginalBtnTxt', getLocalization('Revert to Original', 'ASPxReportsStringId.WebDocumentViewer_AI_RevertToOriginal'))
        .generateProperty('translatedPageBadgeText', getLocalization('AI-generated Translation', 'ASPxReportsStringId.WebDocumentViewer_AIGeneratedTranslation_Label'))
...
export function updatePreviewPageViewModel(args) {
    ...
    else if (args.propertyName === 'imageSrc') {
        viewModel.imageSrc = this.imageSrc;
    }
    ...
    else if (args.propertyName === 'page_id') {
        viewModel.page_id = this.page_id;
    }
    else if (args.propertyName === 'aiCustomDocumentStorageId') {
        viewModel.aiCustomDocumentStorageId = this.aiCustomDocumentStorageId;
    }
