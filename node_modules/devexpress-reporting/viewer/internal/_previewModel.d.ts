...
import { DxPromise, IDesignerPart, ToolbarKeyboardHelper } from '@devexpress/analytics-core/analytics-internal-native';
...
export declare class PreviewDisposableModel extends PreviewDisposableModelBase implements IPreviewModelBase {
    ...
    StartBuild(): void;
    PerformCustomDocumentOperation(customData?: string, hideMessageFromUser?: boolean): DxPromise<IDocumentOperationResult>;
}
