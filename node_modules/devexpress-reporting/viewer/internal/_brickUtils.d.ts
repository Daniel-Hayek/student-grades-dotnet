...
export declare function initializeBrick(brick: IBrickNode, processClick: (target: IBrickNode, e?: JQueryEventObject) => void, editingFieldBricks: IBrickNode[], activeBricksMap: {
    [key: string]: IBrickNode;
} | null): void;
