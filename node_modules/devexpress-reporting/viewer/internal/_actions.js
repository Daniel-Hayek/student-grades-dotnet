    ...
    constructor(reportPreview) {
        ...
        this.displayExpr = (val) => {
            if (val === ZoomAutoBy.PageWidth) {
                return getLocalization('Page Width', 'PreviewStringId.MenuItem_ZoomPageWidth');
            }
...
class HighlightingAction extends ViewerAction {
    constructor(reportPreview) {
        ...
        this.addDisposable(EditablePreviewEnabled.subscribe(() => this.visible = this.isVisible()));
