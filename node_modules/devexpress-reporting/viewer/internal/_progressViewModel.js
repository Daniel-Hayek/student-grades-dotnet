...
export class ProgressViewModel extends BaseRenderingModel {
    ...
    updateViewModel(args) {
        ...
        if (args.propertyName === 'progressBarAccessibilityKeyboardHelper' || args.propertyName === 'progressBarAccessibility')
            viewModel.progressBarAccessibilityKeyboardHelper = this.progressBarAccessibility;
    }
    createViewModel() {
    ...
    startProgress(startOperationId, onStop, operationIdPromise) {
        if (this.progressBarAccessibility) {
            this.progressBarAccessibility.dispose();
            this.progressBarAccessibility = new ListKeyboardHelper();
        }
        if (this.inProgress) {
            this.cancelAction();
