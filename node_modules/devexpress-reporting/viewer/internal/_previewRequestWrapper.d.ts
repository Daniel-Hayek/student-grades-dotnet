...
export declare class PreviewRequestWrapper implements IEditingFieldHtmlProvider {
    ...
    stopSearch(searchOperationId: string, ignore: boolean): DxPromise<any>;
    translateTextRequest(text: string, toLanguage: string, isWholeDocument: boolean, prevResponse?: string, currentChunkPosition?: number, summaryTranslation?: boolean, ignore?: boolean): DxPromise<IAITextTranslationResponse>;
    translateDocumentInPlaseRequest(brickIndexes: string[], toLanguage: string, isWholeDocument: boolean, prevResponse?: string, currentChunkPosition?: number, pageIndex?: number, aiCustomDocumentStorageId?: string, ignore?: boolean): DxPromise<any>;
