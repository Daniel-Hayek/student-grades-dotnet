/**
* DevExpress HTML/JS Reporting (dx-rich-edit-bindings.generated.js)
* Version:  25.2.4
...
addToBindingsCache('dragDropFileToControl: { dragDropHandler: $root.toolboxDragHandler, dragDropFileEnabled: dragDropFileEnabled}, event: { dblclick: function() { $root.richInlineControl.show($element) } }, visible: selected() || focused(), css: {\'dxrd-selected dxrd-context-menu-container\': selected, \'dxrd-focused\': focused, \'dxrd-intersect\': isIntersect, \'dxrd-locked\': locked,  \'dxrd-drop-zone-border\': showDropBorders }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor', function ($context, $element) { return { 'dragDropFileToControl': function () { return { 'dragDropHandler': $context.$root.toolboxDragHandler, 'dragDropFileEnabled': $context.$data.dragDropFileEnabled }; }, 'event': function () { return { 'dblclick': function () { $context.$root.richInlineControl.show($element); } }; }, 'visible': function () { return $context.$data.selected() || $context.$data.focused(); }, 'css': function () { return { 'dxrd-selected dxrd-context-menu-container': $context.$data.selected, 'dxrd-focused': $context.$data.focused, 'dxrd-intersect': $context.$data.isIntersect, 'dxrd-locked': $context.$data.locked, 'dxrd-drop-zone-border': $context.$data.showDropBorders }; }, 'resizable': function () { return $context.$root.resizeHandler; }, 'draggable': function () { return $context.$root.dragHandler; }, 'styleunit': function () { return $context.$data.position; }, 'trackCursor': function () { return $context.$data.underCursor; } }; });
