...
<script type="text/html" id="dxrd-crossband-selection">
    <div class="dxrd-cross-band" data-bind="
        visible: isSelected() && !$root.dx._static.DragDropHandler.started(),
        css: {'dxrd-selected dxrd-context-menu-container': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked },
        resizable: $root.resizeHandler,
        draggable: $root.dragHandler,
        styleunit: position,
        trackCursor: underCursor">

    </div>
    <div class="dxrd-crossband-selection-box dxrd-position-absolute" data-bind="visible: !isSelected(), styleunit: { left: rect().left, top: rect().top, width: 0, height: 0 }">
        <div class="dxrd-crossband-selection-right dxrd-position-absolute" data-bind="styleunit: { left: rect().width - 5, top: -5, width: 10, height: rect().height + 10 }, trackCursor: selectionUnderCursor"></div>
        <div class="dxrd-crossband-selection-top dxrd-position-absolute" data-bind="styleunit: { left: -5, top: -5, width: rect().width + 10, height: 10 }, trackCursor: selectionUnderCursor"></div>
        <div class="dxrd-crossband-selection-left dxrd-position-absolute" data-bind="styleunit: { left: -5, top: -5, width: 10, height: rect().height + 10 }, trackCursor: selectionUnderCursor"></div>
        <div class="dxrd-crossband-selection-bottom dxrd-position-absolute" data-bind="styleunit: { left: -5, top: rect().height - 5, width: rect().width + 10, height: 10 }, trackCursor: selectionUnderCursor"></div>
    </div>
</script>
                        ...
                        <div class="dxrd-ghost-container" data-bind="styleunit: { 'width': pageWidthWithoutMargins, 'height': minHeight }">
                            ...
                            <div class="dxrd-bands-content dxrd-selection" data-bind="styleunit: { 'width': pageWidthWithoutMargins }">
                                <div class="dxrd-bands-content-offset">
                                    ...
                                    <!-- ko foreach: crossBandControls -->
                                    <!-- ko if: visible -->
                                    <!-- ko template: { name: 'dxrd-crossband-selection' } -->
                                    <!-- /ko -->
                                    <!-- /ko -->
                                    <!-- /ko -->
