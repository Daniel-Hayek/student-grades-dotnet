...
declare module DevExpress.Reporting.Chart.Internal {
    ...
    export class ChartRequests {
        static getChartImage(uri: string, chartLayout: any, width: number, height: number): DevExpress.Analytics.Internal.DxPromise<any>;
...
declare module DevExpress.Reporting.Designer.Internal {
    ...
    import UndoEngine = DevExpress.Analytics.Utils.UndoEngine;
    import dxDataGridOptions = ;
    null.dxDataGridOptions;
    ...
    import CustomRule = DevExpress.common.CustomRule;
    ...
    import MongoDBDataSource = DevExpress.Analytics.Data.MongoDBDataSource;
    ...
    import ReportUnit = DevExpress.Reporting.Designer.Wizard.ReportUnit;
    ...
    import IAITextTranslationResponse = DevExpress.Reporting.Viewer.Internal.IAITextTranslationResponse;
    ...
    import FieldListProvider = DevExpress.Analytics.Internal.FieldListProvider;
    import IReportDesignerTreeListItem = DevExpress.Reporting.Designer.Internal.IReportDesignerTreeListItem;
    ...
    import IPreviewAISettings = DevExpress.Reporting.Viewer.Utils.IPreviewAISettings;
    ...
    import IAISettings = DevExpress.Reporting.Designer.Utils.IAISettings;
    ...
    import MongoDBDataSourceEditor = DevExpress.Reporting.Designer.Internal.MongoDBDataSourceEditor;
    import ISerializableModel = DevExpress.Analytics.Utils.ISerializableModel;
    ...
    import IComponent = DevExpress.Analytics.Utils.IComponent;
    import IExpressionOptions = DevExpress.Analytics.Widgets.IExpressionOptions;
    import ICriteriaEditorContext = DevExpress.Analytics.Widgets.Internal.ICriteriaEditorContext;
    ...
    export class ReportScriptService {
        static validateScripts(report: DevExpress.Reporting.Designer.Controls.ReportViewModel): DevExpress.Analytics.Internal.DxPromise<any>;
        static getCompletions(editor: any, session: any, pos: any, prefix: any, callback: any, report: any, editorInstance: any, guid: string): DevExpress.Analytics.Internal.DxPromise<any>;
        static setCodeDom(key: string, reportLayout: string): DevExpress.Analytics.Internal.DxPromise<any>;
    }
    ...
    export class ErrorPanelViewModel extends Disposable {
        ...
        _accessibilityCheckerMessage: any;
        clear(): void;
        ...
        getIconTemplateByErrorCategory(rowData: DevExpress.Reporting.Designer.Internal.IErrorModel): string;
        getIconTemplateName(errorType: DevExpress.Reporting.Designer.Internal.ErrorType): string;
        getTitleByErrorType(errorType: DevExpress.Reporting.Designer.Internal.ErrorType): string;
        _getTotalCountByErrorType(errorType: DevExpress.Reporting.Designer.Internal.ErrorType): number;
    ...
    export class ReportRenderingService {
        static getChartImage(surface: DevExpress.Reporting.Designer.Controls.XRChartSurface): DevExpress.Analytics.Internal.DxPromise<any>;
        static getUnknownControlImage(model: any, scale: number): DevExpress.Analytics.Internal.DxPromise<any>;
        static getShapeImage(surface: DevExpress.Reporting.Designer.Controls.XRShapeControlSurface): DevExpress.Analytics.Internal.DxPromise<any>;
        static getRichImage(surface: DevExpress.Reporting.Designer.Controls.XRRichSurface, propertyName: any): DevExpress.Analytics.Internal.DxPromise<any>;
        static getPdfContentData(control: DevExpress.Reporting.Designer.Controls.XRPdfContentViewModel): DevExpress.Analytics.Internal.DxPromise<any>;
    }
    ...
    export class DesignerErrorProvider extends Disposable implements IErrorProvider {
        private _report;
        errors: ko.ObservableArray<DevExpress.Reporting.Designer.Internal.IErrorModel>;
        collectErrors(): DevExpress.Analytics.Internal.DxPromise<any>;
    ...
    export interface IReportDesignerTreeListItem extends ITreeListItemViewModel {
        ...
        createValidatorOptions: () => {
            validationRules: DevExpress.common.CustomRule[];
        };
    ...
    export class ReportDesignerTreelistItem extends TreeListItemViewModel {
        ...
        createViewModel(): DevExpress.Reporting.Designer.Internal.IReportDesignerTreeListItem;
        dispose(): void;
        renameMode: boolean;
        disabled: boolean;
    }
    ...
    export class FieldListDataSourcesHelper implements IDisposable {
        ...
        private _dataSourceChangeSubscription;
    ...
    export class ReportDataSourceService {
        ...
        static getWizardMongoDBDataConnections(): DevExpress.Analytics.Internal.DxPromise<IConnectionStringDefinition[]>;
        ...
        static getMongoDBDataSourceBase64(dataSource: DevExpress.Analytics.Data.MongoDBDataSource): DevExpress.Analytics.Internal.DxPromise<{
            base64: string;
        }>;
        ...
        static getMongoDBDataSourceFromBase64(base64: string): DevExpress.Analytics.Internal.DxPromise<{
            mongoDBDataSourceJSON: string;
        }>;
    }
    ...
    export interface IReportWizardCallbacks extends IMultiQueryDataSourceWizardCallbacks {
        ...
        createMongoDBDataSourceInfo?: (dataSource: DevExpress.Analytics.Data.MongoDBDataSource) => DevExpress.Analytics.Internal.DxPromise<IDataSourceInfo>;
    }
    export interface IReportWizardFieldsCallback {
        (request: DevExpress.Analytics.Utils.IPathRequest, dataSource: DevExpress.Analytics.Internal.IAnalyticDataSourceInfo, useCache?: boolean): JQueryPromise<DevExpress.Analytics.Utils.IDataMemberInfo[]>;
    }
    ...
    export class DataMemberCustomCheckedTreeNode extends DataMemberTreeNode {
        constructor(name: string, displayName: string, specifics: string, isChecked: boolean, pathParts: string[], afterCheckToggled?: (node: DevExpress.Analytics.Wizard.Internal.DataMemberTreeNode) => void);
    ...
    export class MasterDetailRequestModel extends CommonRequestModel {
        ...
        ReportUnit: DevExpress.Reporting.Designer.Wizard.ReportUnit;
    ...
    export const AIGeneratedReportId = "IsAIReportType";
    export function isAIReportType(state: DevExpress.Reporting.Designer.Wizard.IReportWizardState): boolean;
    ...
    export class DataSourceWizardHelper<TState = any, TSource = any> {
        private _page;
        private _callback;
        ...
        commit(superCommit: () => DevExpress.Analytics.Internal.DxPromise<TState>, createDataSource: (state: TState) => TSource): JQuery.Promise<any, any, any>;
    }
    export const CONVERSION_COEEFICIENT = 0.03937007874015748;
    ...
    export class ReportWizardService {
        ...
        static getLabelReportWizardData(): DevExpress.Analytics.Internal.DxPromise<any>;
    ...
    export class PageSetupHelper {
        static getConverter(from: DevExpress.Reporting.Designer.Wizard.ReportUnit, to: DevExpress.Reporting.Designer.Wizard.ReportUnit): (val: number) => number;
    }
    ...
    export class ReportPreviewService {
        static _getInitializePreviewArgs(report: DevExpress.Reporting.Designer.Controls.ReportViewModel): {
            layout: string;
            culture: string;
        };
        static initializePreview(report: DevExpress.Reporting.Designer.Controls.ReportViewModel): DevExpress.Analytics.Internal.DxPromise<IPreviewInitialize>;
    }
    export class ReportAIService {
        static localize(strings: string[], language: string): DevExpress.Analytics.Internal.DxPromise<IAITextTranslationResponse>;
        static initializePreviewWithFakeData(report: DevExpress.Reporting.Designer.Controls.ReportViewModel): DevExpress.Analytics.Internal.DxPromise<IPreviewInitialize>;
    }
    export class ReportPreviewServiceHelper {
        private initializeDeferred;
        initializePreview(report: DevExpress.Reporting.Designer.Controls.ReportViewModel, useAI?: boolean): DevExpress.Analytics.Internal.DxPromise<IPreviewInitialize>;
    }
    ...
    export class LocalizationEditor extends Disposable {
        ...
        getLoadPanelOptions(element: any): {
            visible: ko.Observable<boolean>;
            shading: boolean;
            position: {
                of: HTMLElement;
    ...
    export class DataSourceActions implements IActionsProvider {
        ...
        filterEditor: ko.Observable<DevExpress.Analytics.Widgets.FilterEditor>;
        editDataSourceFilter(item: DevExpress.Reporting.Designer.Internal.IReportDesignerTreeListItem): void;
        rebuildResultSchemaAction: DevExpress.Analytics.Utils.IAction;
        renameAction: DevExpress.Analytics.Utils.IAction;
        filterDataSourceAction: DevExpress.Analytics.Utils.IAction;
        getActions(context: DevExpress.Reporting.Designer.Internal.ReportDesignerTreelistItem): DevExpress.Analytics.Utils.IAction[];
    }
    ...
    export class MongoDBDataSourceEditor extends DataSourceEditorBase {
        ...
        editSchema(dataSourceID: string): void;
        applyDataSourceWizardChanges(dataSourceWizardModel: DevExpress.Analytics.Wizard.IDataSourceWizardState): DevExpress.Analytics.Internal.DxPromise<IDataSourceInfo>;
        static createMongoDBDataSourceInfo(source: DevExpress.Analytics.Data.MongoDBDataSource): DevExpress.Analytics.Internal.DxPromise<IDataSourceInfo>;
        editSchemaAction: {
            clickAction: (item: any) => void;
            position: number;
            imageClassName: string;
    ...
    export interface IReportDesignerGeneratorSettings {
        ...
        aiSettings?: DevExpress.Reporting.Designer.Utils.IAISettings;
    ...
    export interface PreviewOptions {
        ...
        progressBarSettings?: DevExpress.Reporting.Viewer.Utils.IProgressBarSettings;
        searchSettings?: DevExpress.Reporting.Viewer.Utils.ISearchSettings;
        aiSettings?: DevExpress.Reporting.Viewer.Utils.IPreviewAISettings;
    }
    export class WizardsInitializerSettings {
        ...
        mongoDBDataSourceEditor: DevExpress.Reporting.Designer.Internal.MongoDBDataSourceEditor;
        ...
        createSqlDataSourceEditor(settings: {
            ...
            displayNameProvider: ko.Observable<DevExpress.Reporting.Designer.Internal.DisplayNameProvider> | ko.Computed<DevExpress.Reporting.Designer.Internal.DisplayNameProvider>;
            rtl: boolean;
    ...
    export interface IExpressionObject extends IDisposable {
        getInfo(info?: DevExpress.Analytics.Utils.ISerializationInfoArray): DevExpress.Analytics.Utils.ISerializationInfoArray;
        getExpression(propertyName: string, eventName?: string): WrappedExpressionOptions;
    ...
    interface IReportExpressionOptions extends IExpressionOptions {
        propertyName?: string;
        control: DevExpress.Analytics.Utils.IComponent;
    }
    export class WrappedExpressionOptions extends Disposable implements IExpressionOptions {
        eventName?: string;
        constructor(options: IReportExpressionOptions, handlers?: {
        ...
        customizeContext?: (context: DevExpress.Analytics.Widgets.Internal.ICriteriaEditorContext) => void;
        rootItems: ({
            name: string;
            needPrefix: boolean;
            rootPath?: undefined;
    ...
    export class ExpressionWrapper extends Disposable {
        ...
        createExpressionsObject(control: DevExpress.Reporting.Designer.Controls.XRReportElementViewModel, expressions: ko.ObservableArray<DevExpress.Reporting.Designer.Controls.IExpressionBinding>, path?: ko.Observable<string> | ko.Computed<string>, summaryRunning?: (name: string) => ko.Observable<boolean> | ko.Computed<boolean>): DevExpress.Reporting.Designer.Internal.IExpressionObject;
    ...
    export class ControlConverterService {
        static getXmlStringFromJson(controlJsonLayout: string, doneCallback: (result: any) => void, errorCallback: (error: any) => void): DevExpress.Analytics.Internal.DxPromise<any>;
        static getControlModelFromXmlString(controlXmlLayout: string, doneCallback: (result: any) => void, errorCallback: (error: any) => void): DevExpress.Analytics.Internal.DxPromise<any>;
    }
    ...
    export class ReportControlsDragDropHelper extends ObjectExplorerDragDropHelper {
        ...
        protected _shouldCheckAreas(): boolean;
        protected _getDroppableClassName(isInTopOrderArea: boolean, isInBottomOrderArea: boolean): string;
        updateLevels(targetModel: DevExpress.Analytics.Elements.ElementViewModel): void;
    ...
    export class AIDesignerPanelModel extends Disposable {
        buildingModel: DevExpress.Reporting.Designer.IReportDesignerRootContext;
        settings: DevExpress.Reporting.Designer.Utils.IAISettings;
        constructor(buildingModel: DevExpress.Reporting.Designer.IReportDesignerRootContext, settings: DevExpress.Reporting.Designer.Utils.IAISettings);
        showPreviewWithFakeData(): void;
        get fakePreviewButtonVisible(): boolean;
        get fakePreviewButtonText(): any;
        get fakePreviewButtonTitle(): any;
        visible: boolean;
    }
    export class ReportDesignerInitializer extends CommonDesignerGenerator<DevExpress.Reporting.Designer.IReportDesignerRootContext> {
        ...
        private _mongoDBDataSourceEditor;
        ...
        addAIFeatures(aiSettings: DevExpress.Reporting.Designer.Utils.IAISettings): ReportDesignerInitializer;
        ...
        tryAddCollectionDataSourceFilterEditorAddon(filterEditor?: ko.Observable<any>): this;
    ...
    export class RulerViewModel extends Disposable {
        ...
        _getGridSize(numberOfIntervalsBetweenMajorTicks: number, units: DevExpress.Analytics.Internal.MeasureUnit, zoom: number): number;
        height: ko.Observable<number>;
        width: ko.Observable<number>;
    ...
    export class FormatStringService {
        static saveCustomPattern(typeString: string, format: string): DevExpress.Analytics.Internal.DxPromise<any>;
        static removeCustomPattern(typeString: string, format: string): DevExpress.Analytics.Internal.DxPromise<any>;
        static updatePreview(value: string, typeString: string, format: string): DevExpress.Analytics.Internal.DxPromise<any>;
...
declare module DevExpress.Reporting.Chart.Internal.Widgets {
    ...
    export interface IChartDataSourceEditorViewModel extends IEditorViewModel {
    ...
    export interface IPointsEditorViewModel extends IEditorViewModel {
        addPoint: () => any;
    }
    export class PointsEditor extends Editor {
        createViewModel(): IPointsEditorViewModel;
        constructor(info: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: ko.Computed<boolean>, textToSearch?: any);
        addPoint(): DevExpress.Reporting.Chart.Internal.Series.SeriesPointModel;
    }
    ...
    export interface IViewEditorViewModel extends IEditorViewModel {
        generateViewItems: () => any;
        generateHeaderValue: (undoEngine: ko.Observable<DevExpress.Analytics.Utils.UndoEngine>) => any;
        contentValue: ko.Subscribable<any>;
    }
...
declare module DevExpress.Reporting.Designer.Controls.Metadata {
    ...
    export const textAccessibleRole: DevExpress.Analytics.Utils.ISerializationInfo;
    export const imageAccessibleRole: DevExpress.Analytics.Utils.ISerializationInfo;
    export const wmTextAccessibleDescription: any;
    export const wmImageAccessibleDescription: any;
    ...
    export const snappingMode: DevExpress.Analytics.Utils.ISerializationInfo;
    ...
    export const pageWidthF: DevExpress.Analytics.Utils.ISerializationInfo;
    export const pageHeightF: DevExpress.Analytics.Utils.ISerializationInfo;
    ...
    export const lineSpacing: DevExpress.Analytics.Utils.ISerializationInfo;
    export const angle: DevExpress.Analytics.Utils.ISerializationInfo;
    ...
    export const filterString: DevExpress.Analytics.Utils.ISerializationInfo;
    export const filterStringEditable: DevExpress.Analytics.Utils.ISerializationInfo;
    export const collectionDataSourceCriteria: {
        propertyName: string;
        modelName: string;
        displayName: string;
        localizationId: string;
    ...
    export const xafPropertiesInfo: DevExpress.Analytics.Utils.ISerializationInfo[];
    ...
    export const canPublishOptions: DevExpress.Analytics.Utils.ISerializationInfo;
    ...
    export const decorativeAccessibleRole: {
        value: string;
        displayValue: string;
        localizationId: string;
    };
    export const paragraphAccessibleRole: {
        value: string;
        displayValue: string;
        localizationId: string;
    };
    export const figureAccessibleRole: {
        value: string;
        displayValue: string;
        localizationId: string;
    };
    ...
    export const defaultDecorativeAccessibleRole: any;
...
declare module DevExpress.Reporting.Designer.Controls {
    ...
    import PropertyModificationModel = DevExpress.Analytics.Elements.PropertyModificationModel;
    ...
    import DefinitionUpdater = DevExpress.Reporting.Designer.Controls.CrossTab.DefinitionUpdater;
    ...
    export class FormattingRule extends Disposable {
        ...
        conditionObj: DevExpress.Analytics.Widgets.IExpressionOptions;
    }
    ...
    export class XRCrossBandSurface extends XRControlSurfaceBase<DevExpress.Reporting.Designer.Controls.XRCrossBandControlViewModel> {
        ...
        edgeUnderCursor: ko.Observable<DevExpress.Analytics.Internal.IHoverInfo>;
        underCursor: ko.Observable<DevExpress.Analytics.Internal.IHoverInfo>;
        selectionUnderCursor: ko.Observable<DevExpress.Analytics.Internal.IHoverInfo>;
    ...
    export const textAccessibleOptions: DevExpress.Analytics.Utils.ISerializationInfo;
    export const imageAccessibleOptions: DevExpress.Analytics.Utils.ISerializationInfo;
    export class AccessibleOptionsModel extends BaseRenderingMultiplatformModel<DevExpress.Analytics.Serializer.Native.IViewModel> {
        constructor(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer);
        isPropertyDisabled(propertyName: string): boolean;
        watermarkModel: DevExpress.Reporting.Designer.Controls.WatermarkModel;
        accessibleRole: ko.Observable<string>;
        accessibleDescription: ko.Observable<string>;
    }
    export class ImageAccessibleOptions extends AccessibleOptionsModel {
        constructor(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer);
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
        static from(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer): ImageAccessibleOptions;
        isPropertyDisabled(propertyName: string): boolean;
    }
    export class TextAccessibleOptions extends AccessibleOptionsModel {
        constructor(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer);
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
        static from(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer): TextAccessibleOptions;
        isPropertyDisabled(propertyName: string): boolean;
    }
    export class WatermarkModel extends BaseRenderingMultiplatformModel<DevExpress.Reporting.Designer.Controls.WatermarkModel> implements IStyleContainer {
        constructor(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer);
        ...
        textAccessibleOptions: TextAccessibleOptions;
    ...
    export class ComponentsModel extends Disposable {
        ...
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
        constructor(model: DevExpress.Analytics.Internal.IDataSourceInfo, renameComponentStrategy: DevExpress.Reporting.Designer.Internal.IRenameComponentStrategy, parameters?: ko.ObservableArray<DevExpress.Reporting.Designer.Data.Parameter>);
        className: () => string;
        controlType: string;
        name: ko.Observable<string> | ko.Computed<string>;
    ...
    export class XRPdfContentViewModel extends XRControlViewModel {
        ...
        backgroundImage: ko.Observable<string>;
        imageWidth: number;
        imageHeight: number;
    ...
    export class XRRichSurface extends XRControlSurface {
        private _primaryProperties;
        private _secondaryPropertiesChangedRequest;
        private _lastRequestedProperty;
    ...
    export class TableOfContentsLevel extends ElementViewModel<DevExpress.Reporting.Designer.Internal.ControlType> {
        ...
        beforeDeserialize(model: any): void;
    ...
    export class ActionTypeBase extends PropertyModificationModel implements ISerializableModel {
    ...
    export class XRControlViewModel extends XRReportElementViewModel {
        ...
        beforeDeserialize(model: any, parent: DevExpress.Analytics.Elements.ElementViewModel<ControlType>, serializer?: DevExpress.Analytics.Utils.IModelSerializer): void;
        ...
        getFieldName(value: string, fieldNameOption: FieldNameOptions): {
            dataMember: string;
            namePromise: DevExpress.Analytics.Internal.DxPromise<string>;
        };
        setTextValue(fieldNamePromise: DevExpress.Analytics.Internal.DxPromise<string>, originText: string, replacedText: string, propertyToSet: ko.Computed<string> | ko.Observable<string>): void;
    ...
    export class ReportViewModel extends XRReportElementViewModel implements IModelReady {
        ...
        isPropertyDisabled(name: string): boolean;
        dispose(): void;
        beforeDeserialize(reportModel: any): void;
        constructor(report: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer, knownEnums?: DevExpress.Reporting.IEnumType[]);
        shouldSerialize(propertyName: string, viewModel: DevExpress.Reporting.Designer.Controls.ReportViewModel): boolean;
        isLocalized(): boolean;
        initialize(): void;
        ...
        onSave: (data: any) => void;
        dataSourceHelper: ko.Observable<DevExpress.Reporting.Designer.Internal.DataSourceHelper>;
        displayNameProvider: ko.Observable<DevExpress.Reporting.Designer.Internal.DisplayNameProvider>;
        ...
        measureUnit: ko.Observable<DevExpress.Analytics.Internal.MeasureUnit> | ko.Computed<DevExpress.Analytics.Internal.MeasureUnit>;
        snapGridSize: ko.Observable<number> | ko.Computed<number>;
        snappingMode?: ko.Observable<string> | ko.Computed<string>;
        pageWidthF: ko.Observable<number> | ko.Computed<number>;
        pageHeightF: ko.Observable<number> | ko.Computed<number>;
    ...
    export class ControlsFactory extends AnalyticControlsFactory<DevExpress.Reporting.Designer.Internal.ControlType> implements IDisposable {
        ...
        _createExpressionObject(control: DevExpress.Reporting.Designer.Controls.XRReportElementViewModel, expressions: ko.ObservableArray<DevExpress.Reporting.Designer.Controls.IExpressionBinding>, path?: ko.Computed<string>, summaryRunning?: (name: string) => ko.Observable<boolean> | ko.Computed<boolean>): DevExpress.Reporting.Designer.Internal.IExpressionObject;
    ...
    export class XRCrossTabCellViewModel extends XRControlViewModel implements ICrossTabCell {
        ...
        get _rowVisible(): boolean;
        set _rowVisible(value: boolean);
        get _columnVisible(): boolean;
        set _columnVisible(value: boolean);
        ...
        cellRows: ko.Computed<Array<any>>;
        fieldName: ko.Observable<string> | ko.Computed<string>;
        summaryType: any;
        ...
        textFormatString: ko.Observable<string> | ko.Computed<string>;
        rowVisible: ko.Observable<boolean>;
        columnVisible: ko.Observable<boolean>;
    ...
    export class XRCrossTabViewModel extends XRControlViewModel {
        ...
        definitionUpdater: DevExpress.Reporting.Designer.Controls.CrossTab.DefinitionUpdater;
        isModelReady: ko.Computed<boolean>;
...
declare module DevExpress.Reporting.Designer.Widgets {
    ...
    import PopupService = DevExpress.Analytics.Internal.PopupService;
    import Popover = DevExpress.Analytics.Utils.Popover;
    import IDataSourceInfo = DevExpress.Analytics.Internal.IDataSourceInfo;
    ...
    import DataSourceSelectBox = DevExpress.Reporting.Designer.Widgets.DataSourceSelectBox;
    import IDisplayedObject = DevExpress.Analytics.Internal.IDisplayedObject;
    ...
    const CanPublishToFormatSpecifics: {
        readonly Csv: number;
    ...
    export class CanPublishEditor extends Editor {
        editorValue: ko.Computed<CanPublishToFormatSpecificsKeys[]>;
        constructor(info: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: ko.Computed<boolean>, textToSearch?: any, popupService?: DevExpress.Analytics.Internal.PopupService, popover?: DevExpress.Analytics.Utils.Popover, engineType?: DevExpress.Analytics.Serializer.Native.EngineType);
    ...
    export const PageSizeEditorFormatMapper: {
        measureUnit: {
            Inches: string;
            HundredthsOfAnInch: string;
            Millimeters: string;
            TenthsOfAMillimeter: string;
            Pixels: string;
        };
    };
    export class PageSizeEditor extends Editor {
        constructor(info: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: ko.Computed<boolean>, textToSearch?: any);
        getOptions(templateOptions: any): object;
        _format: DevExpress.Analytics.Serializer.Native.MultiPlatformObservable<string>;
    }
...
declare module DevExpress.Reporting.Designer.Bands {
    ...
    import BandViewModel = DevExpress.Reporting.Designer.Bands.BandViewModel;
    import ControlType = DevExpress.Reporting.Designer.Internal.ControlType;
    import SortableBandViewModel = DevExpress.Reporting.Designer.Bands.SortableBandViewModel;
    import IElementViewModel = DevExpress.Analytics.Elements.IElementViewModel;
    import FilterStringOptions = DevExpress.Analytics.Widgets.FilterStringOptions;
    import ObjectStorageItem = DevExpress.Reporting.Designer.Data.ObjectStorageItem;
    ...
    export class DetailBand extends BandViewModel {
        static unitProperties: any[];
        dispose(): void;
        afterDeserialize(band: any, parent: DevExpress.Analytics.Elements.ElementViewModel, serializer?: DevExpress.Analytics.Utils.ModelSerializer): void;
    ...
    export class GroupBandViewModel extends SortableBandViewModel {
        ...
        getSortedGroupBands(parentBands: DevExpress.Reporting.Designer.Bands.BandViewModel[]): GroupBandViewModel[];
        findMinPossibleLevel(parentBands: ko.ObservableArray<DevExpress.Reporting.Designer.Bands.BandViewModel>): number;
    }
    ...
    export abstract class SortableBandViewModel extends BandViewModel {
        _level: ko.Observable<number> | ko.Computed<number>;
        level: ko.Observable<number> | ko.Computed<number>;
        maxLevel: ko.Observable<number> | ko.Computed<number>;
        private _initialLevel;
        constructor(band: any, parent: DevExpress.Analytics.Elements.ElementViewModel<ControlType>, serializer?: DevExpress.Analytics.Utils.ModelSerializer);
        getFilteredParentBands(): DevExpress.Reporting.Designer.Bands.SortableBandViewModel[];
        protected _reorderLevelsCore(newLevelValue: number): void;
        ...
        reorderLevels(maxLevel: number, newValue: number): void;
        updateLevelsOnInsert(maxLevel: number, newValue: number): void;
        private _getInitialLevel;
    }
    export class SubBandViewModel extends SortableBandViewModel {
        constructor(band: any, parent: DevExpress.Analytics.Elements.ElementViewModel<ControlType>, serializer?: DevExpress.Analytics.Utils.ModelSerializer);
        isPropertyVisible(name: string): boolean;
        isPropertyDisabled(name: string): any;
    ...
    export class DetailReportBand extends SortableBandViewModel {
        dataMember: ko.Observable<string> | ko.Computed<string>;
        dataSource: ko.Observable<DevExpress.Reporting.Designer.Data.ObjectStorageItem>;
    ...
    export class VerticalBandViewModel extends BandViewModel {
        ...
        initSize(): void;
        constructor(band: any, parent: DevExpress.Analytics.Elements.ElementViewModel<ControlType>, serializer?: DevExpress.Analytics.Utils.ModelSerializer);
        isPropertyVisible(name: keyof DevExpress.Reporting.Designer.Bands.VerticalBandViewModel): boolean;
    ...
    export class BandViewModel extends XRReportElementViewModel {
        ...
        isAllowedParent(target: DevExpress.Analytics.Elements.IElementViewModel): boolean;
        private _isHeaderBandType;
        private _isHeaderOrFooterBand;
        isPropertyVisible(name: string): boolean;
        isPropertyDisabled(name: string): any;
        size: DevExpress.Analytics.Elements.Size;
        name: ko.Observable<string> | ko.Computed<string>;
...
declare module DevExpress.Reporting.Viewer.Widgets.Internal {
    ...
    import ValueChangedEvent = DevExpress.ui.dxSlider.ValueChangedEvent;
    import getParentContainer = DevExpress.Analytics.Internal.getParentContainer;
    import IModel = DevExpress.Analytics.Serializer.Native.IModel;
    ...
    export interface IImagePickerActionViewModel extends IViewModel {
        ...
        contentWidth: number;
        height: number;
        onFilterChanged: (event: DevExpress.ui.dxSlider.ValueChangedEvent) => void;
        searchPlaceholder: string;
    }
    ...
    export interface IPainterBrushOptions {
        lineWidth: number;
        lineColor: string;
        onLineWidthChanged: (event: DevExpress.ui.dxSlider.ValueChangedEvent) => void;
...
declare module DevExpress.Reporting.Viewer.Parameters {
    ...
    import dxButtonProperties = DevExpress.ui.dxButton.dxButtonProperties;
    ...
    export class ParameterPanelItemBase<T extends DevExpress.Analytics.Serializer.Native.IViewModel> extends BaseRenderingModel<T> {
        ...
        onPropertyChanged(args: DevExpress.Analytics.Serializer.Native.PropertyChangedEventArgs<any> | DevExpress.Analytics.Serializer.Native.ArrayPropertyChangedEventArgs<any>): void;
        constructor(parameterHelper: DevExpress.Reporting.Viewer.Parameters.PreviewParameterHelper, _layoutInfo?: DevExpress.Reporting.Viewer.Parameters.IParameterPanelItemInfo, _root?: DevExpress.Reporting.Viewer.Parameters.ParameterPanelItemBase<T>);
    ...
    export interface IParametersPanelViewModel extends IViewModel {
        ...
        buttons: DevExpress.ui.dxButton.dxButtonProperties[];
        showButtons: boolean;
        showHeader: boolean;
    }
    ...
    export class PreviewParameterHelper extends ParameterHelper {
        ...
        mapLookUpValues(type: string, lookUpValues: Array<DevExpress.Reporting.Viewer.Parameters.ILookUpValue>, allowNull?: boolean): Array<DevExpress.Analytics.Utils.IDisplayedValue>;
        ...
        getValueConverter(type: string, allowNull?: boolean): (val: any) => any;
        getRangeEditor(type: string): {
            type: string;
            header: string;
        };
...
declare module DevExpress.Reporting.Viewer.Utils {
    ...
    import AnalyticsTemplate = DevExpress.Analytics.Widgets.AnalyticsTemplate;
    ...
    import IEditorViewModel = DevExpress.Analytics.Widgets.IEditorViewModel;
    import ITabPanelItemWithPropertyGridViewModel = DevExpress.Analytics.Utils.ITabPanelItemWithPropertyGridViewModel;
    ...
    export interface IPreviewAISettings {
        translationSettings?: IAITranslationSettings;
        summarizationSettings?: IAISummarizationSettings;
    }
    ...
    export interface IAISummarizationSettings {
    ...
    export type ViewerTemplate = {
        ...
        "dxrd-preview-parameters": DevExpress.Analytics.Utils.ITabPanelItemWithPropertyGridViewModel;
        ...
        "dxrd-preview-export-options": DevExpress.Analytics.Utils.ITabPanelItemWithPropertyGridViewModel;
        "dxrd-preview-document-map": DevExpress.Analytics.Utils.ITabPanelItemWithPropertyGridViewModel;
        ...
        "dxrv-daterange-editor-timeonly-popup": DevExpress.Reporting.Viewer.Widgets.IDateRangeEditorViewModel;
        ...
        "dxrd-preview-search": DevExpress.Analytics.Utils.ITabPanelItemWithPropertyGridViewModel;
        ...
        "dxrv-preview-time-range-mobile": DevExpress.Reporting.Viewer.Mobile.Internal.IDateRangeEditorMobileViewModel;
    ...
    export type TemplateViewModels = DevExpress.Analytics.Widgets.AnalyticsTemplate & ViewerTemplate;
}
declare module DevExpress.Reporting.Viewer.Widgets {
    ...
    import CalendarProperties = DevExpress.ui.dxCalendar.CalendarProperties;
    ...
    import TimeRangeDialogElementsKeyboardHelper = DevExpress.Reporting.Viewer.TimeRangeDialogElementsKeyboardHelper;
    ...
    class PredefinedRangeModel extends BaseModel {
        onPropertyChanged(args: DevExpress.Analytics.Serializer.Native.PropertyChangedEventArgs<any> | DevExpress.Analytics.Serializer.Native.ArrayPropertyChangedEventArgs<any>): void;
        dateRanges: DevExpress.Reporting.Viewer.Widgets.IDateRangeEditorItem[];
        timeRanges: DevExpress.Reporting.Viewer.Widgets.IDateRangeEditorItem[];
    }
    export const predefinedDateRangesModel: PredefinedRangeModel;
    export const predefinedDateRanges: DevExpress.Reporting.Viewer.Widgets.IDateRangeEditorItem[];
    export const predefinedTimeRanges: DevExpress.Reporting.Viewer.Widgets.IDateRangeEditorItem[];
    export {};
    /// <reference types="jquery" />
    /// <reference types="jquery" />
    ...
    export type IDateRangeCalendarViewModel = {
        value: Date;
        onValueChanged: DevExpress.ui.dxCalendar.CalendarProperties["onValueChanged"];
        min: Date;
        height: string;
        inRange: (date: Date) => boolean;
    };
    export interface IDateRangeEditorViewModel extends IViewModel {
        getPopupSettings: (isTimeOnly: boolean) => DevExpress.ui.dxPopup.PopupProperties;
        ...
        dialogKeyboardHelper: DevExpress.Reporting.Viewer.DateRangeDialogElementsKeyboardHelper | DevExpress.Reporting.Viewer.TimeRangeDialogElementsKeyboardHelper;
    ...
    export function createPredefinedGroupedItemsViewModel(editor: DevExpress.Reporting.Viewer.Widgets.DateRangeEditor): IDateRangeEditorPredefinedItemViewModel[][];
...
declare module DevExpress.Reporting.Viewer.Internal {
    ...
    import CheckBoxOptions = DevExpress.ui.dxCheckBox.CheckBoxOptions;
    import ButtonOptions = DevExpress.ui.dxButton.ButtonOptions;
    import AIPanelViewModel = DevExpress.Reporting.Viewer.Internal.AIPanelViewModel;
    import getParentContainer = DevExpress.Analytics.Internal.getParentContainer;
    ...
    import TabInfo = DevExpress.Analytics.Utils.TabInfo;
    import DxMenuOptions = DevExpress.ui.dxMenu.DxMenuOptions;
    ...
    import ValueChangedEvent = DevExpress.ui.dxCheckBox.ValueChangedEvent;
    import ItemRenderedEvent = DevExpress.ui.dxList.ItemRenderedEvent;
    ...
    export interface IAIPanelViewModel extends IViewModel {
        buttons: {
            translateTextButton: DevExpress.ui.dxButton.ButtonOptions;
            summarizeTextButton: DevExpress.ui.dxButton.ButtonOptions;
            copyResultButton: DevExpress.ui.dxButton.ButtonOptions;
        };
        proceedForAllCheckBoxOptions: DevExpress.ui.dxCheckBox.CheckBoxOptions;
    ...
    export function createViewModel(this: DevExpress.Reporting.Viewer.Internal.AIPanelViewModel, viewModel: DevExpress.Analytics.Serializer.Native.IViewModel): DevExpress.Reporting.Viewer.Internal.IAIPanelViewModel;
    ...
    export class AIPanelViewModel extends BaseRenderingModel<DevExpress.Reporting.Viewer.Internal.IAIPanelViewModel> {
        reportPreview: DevExpress.Reporting.Viewer.ReportPreview;
        settings: DevExpress.Reporting.Viewer.Utils.IPreviewAISettings;
        tabInfo: DevExpress.Analytics.Utils.TabInfo;
        aiProcessingRequestDeferred: DevExpress.Analytics.Internal.DxDeferred<any>;
        tranlsatePagesDeferred: DevExpress.Analytics.Internal.DxDeferred[];
        ignore: boolean;
        aiProcessingResultText: string;
        ...
        smartTagAIMenu: DevExpress.ui.dxMenu.DxMenuOptions;
        ...
        prevRespose: string;
        get _currentPage(): DevExpress.Reporting.Viewer.Internal.PreviewPage;
        constructor(reportPreview: DevExpress.Reporting.Viewer.ReportPreview, settings: DevExpress.Reporting.Viewer.Utils.IPreviewAISettings);
        expandAITabPanel(): void;
        get progressBar(): DevExpress.Reporting.Viewer.Internal.IProgressHandler;
        ...
        revertPageToOriginal(page: DevExpress.Reporting.Viewer.Internal.PreviewPage): void;
        ...
        _handeTranslateInPlaseResult(result: any, page: DevExpress.Reporting.Viewer.Internal.PreviewPage, nextChunkRequestFunc: (prevResultText: string, nextChunkPosition: number, aiCustomDocumentStorageId?: string) => void): void;
        _handleTextProcessingResult(result: DevExpress.Reporting.Viewer.Internal.IAITextTranslationResponse, nextChunkRequestFunc: (prevResultText: string, nextChunkPosition: number) => void, isSummary?: boolean): void;
        _updatePageImage(page?: DevExpress.Reporting.Viewer.Internal.PreviewPage): void;
    ...
    export function initializeBrick(brick: DevExpress.Reporting.Viewer.Utils.IBrickNode, processClick: (target: DevExpress.Reporting.Viewer.Utils.IBrickNode, e?: JQueryEventObject) => void, editingFieldBricks: DevExpress.Reporting.Viewer.Utils.IBrickNode[], activeBricksMap: {
        [key: string]: DevExpress.Reporting.Viewer.Utils.IBrickNode;
    } | null): void;
    /// <reference types="jquery" />
    ...
    export class PreviewPage extends BaseRenderingModel<DevExpress.Reporting.Viewer.Internal.IPreviewPageViewModel> {
        ...
        getActiveBrick(): Array<DevExpress.Reporting.Viewer.Utils.IBrickNode>;
        clearBricks(): void;
        dispose(): void;
        revertToOriginal(): void;
    ...
    interface ISearchEditorCheckBox {
        text: string;
        value: boolean;
        onValueChanged: (event: DevExpress.ui.dxCheckBox.ValueChangedEvent) => void;
    }
    interface ISearchEditorArrowButton {
        template: typeof DevExpress.Analytics.Internal.editor_template;
        icon: string;
        onClick: (event: DevExpress.ui.dxButton.ClickEvent) => void;
    }
    export interface ISearchViewModel extends IViewModel {
        ...
        onItemRendered: (event: DevExpress.ui.dxList.ItemRenderedEvent) => void;
    }
    ...
    export interface IAITextTranslationResponse {
        chunkIndex: number;
        errorMessage: string;
        requestAgain: boolean;
        success: boolean;
    ...
    export class PreviewRequestWrapper implements IEditingFieldHtmlProvider {
        ...
        stopSearch(searchOperationId: string, ignore: boolean): DevExpress.Analytics.Internal.DxPromise<any>;
        translateTextRequest(text: string, toLanguage: string, isWholeDocument: boolean, prevResponse?: string, currentChunkPosition?: number, summaryTranslation?: boolean, ignore?: boolean): DevExpress.Analytics.Internal.DxPromise<IAITextTranslationResponse>;
        translateDocumentInPlaseRequest(brickIndexes: string[], toLanguage: string, isWholeDocument: boolean, prevResponse?: string, currentChunkPosition?: number, pageIndex?: number, aiCustomDocumentStorageId?: string, ignore?: boolean): DevExpress.Analytics.Internal.DxPromise<any>;
    ...
    export class PreviewDisposableModel extends PreviewDisposableModelBase implements IPreviewModelBase {
        ...
        GoToPage(pageIndex: number): void;
        StartBuild(): void;
        PerformCustomDocumentOperation(customData?: string, hideMessageFromUser?: boolean): DevExpress.Analytics.Internal.DxPromise<IDocumentOperationResult>;
    }
...
declare module DevExpress.Reporting.Viewer.Editing {
    ...
    export class ImageEditingFieldViewModel<T extends DevExpress.Reporting.Viewer.Editing.IEditingFieldViewModelBase = DevExpress.Reporting.Viewer.Editing.IEditingFieldViewModelBase> extends EditingFieldBase<T> implements IEditingFieldModel, IPictureEditorFieldModel {
        ...
        constructor(field: DevExpress.Reporting.Viewer.Editing.EditingField<IImageEditValue>, pageWidth: number, pageHeight: number, page: DevExpress.Reporting.Viewer.Internal.PreviewPage);
    ...
    export interface ITextEditingFieldViewModelBase extends IEditingFieldViewModelBase {
        ...
        onInput: (data: any, event: any) => void;
    }
    export class TextEditingFieldViewModelBase<T extends DevExpress.Reporting.Viewer.Editing.ITextEditingFieldViewModelBase> extends EditingFieldBase<T> {
        ...
        onInput(data: ITextEditingFieldData, event: any): void;
        createViewModel(): T;
    ...
    export class TextEditingFieldViewModel extends TextEditingFieldViewModelBase<ITextEditingFieldViewModel> implements IEditingFieldModel {
        constructor(field: DevExpress.Reporting.Viewer.Editing.EditingField<string>, pageWidth: number, pageHeight: number, page: DevExpress.Reporting.Viewer.Internal.PreviewPage);
    ...
    export class EditingField<T = unknown> extends BaseRenderingModel<DevExpress.Reporting.Viewer.Editing.IEditValueContainerViewModel<T>> {
        ...
        createModel(page: DevExpress.Reporting.Viewer.Internal.PreviewPage, pageWidth: number, pageHeight: number, editingFieldsProvider: () => DevExpress.Reporting.Viewer.Editing.EditingField[], bounds: IBounds): DevExpress.Reporting.Viewer.Editing.EditingFieldBase;
    }
...
declare module DevExpress.Reporting.Viewer {
    ...
    import IProgressBarViewModel = DevExpress.Reporting.Viewer.Internal.IProgressBarViewModel;
    import ReportPreview = DevExpress.Reporting.Viewer.ReportPreview;
    import dxLoadingPanelProperties = DevExpress.ui.dxLoadPanel.dxLoadingPanelProperties;
    ...
    export interface IReportPreviewViewModel extends IViewModel {
        ...
        _getAILoadingPanelOptions: (element: HTMLElement) => DevExpress.ui.dxLoadPanel.dxLoadingPanelProperties;
    }
    ...
    export class PreviewBricksKeyboardHelper extends KeyboardHelperWithArrowButtonBase {
        ...
        dispose(): void;
        delayedInit: () => void;
        _subscribeToBricksChanges(): void;
    ...
    export class ReportPreview extends ReportHolder {
        ...
        private _timeouts;
        private _zoomLocker;
        private _currentDrillThroughPromise;
        private _currentStartBuildPromise;
        ...
        _show(initializeDataPromise: DevExpress.Analytics.Internal.DxPromise<IPreviewInitialize>, isAIOperation?: boolean): void;
        ...
        customDocumentOperation(customData?: string, hideMessageFromUser?: boolean): DevExpress.Analytics.Internal.DxPromise<IDocumentOperationResult>;
        ...
        _documentHasTranslation(): boolean;
        ...
        closeDocumentAndReport(documentId?: string, reportId?: string): void;
    ...
    export class TimeRangeDialogElementsKeyboardHelper extends AccessibilityKeyboardHelperBase {
        private _timeRangeEditor;
        controlElementClassName: string;
        predefinedDateRangesKeyboardHelper: PredefinedDateRangesKeyboardHelper;
        constructor(_timeRangeEditor: DevExpress.Reporting.Viewer.Widgets.DateRangeEditor);
        createControlElement(element: HTMLElement, index?: number): DevExpress.Analytics.Internal.AccessibilityControlElementBase;
        itemHandleEscKey(e: any, index?: any): boolean;
        clearSelection(): void;
...
declare module DevExpress.Reporting.Designer.Data {
    ...
    import IScriptingControl = DevExpress.Reporting.Designer.Internal.IScriptingControl;
    import Editor = DevExpress.Analytics.Widgets.Editor;
    import _DxObjectStorageItem = DevExpress.Reporting.Designer.Data._DxObjectStorageItem;
    ...
    export class ObjectStorageItem extends ObjectItem {
        ...
        preInitProperties(model: any): void;
        constructor(model: any, dsHelperProvider?: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer, objectType?: string);
        isEmpty(): boolean;
    ...
    export class _DxObjectStorageItem extends ObjectStorageItem {
        constructor(model: any, dsHelperProvider?: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer);
    }
    ...
    export class ObjectsStorage extends Disposable {
        ...
        addValue(): DevExpress.Reporting.Designer.Data._DxObjectStorageItem;
...
declare module DevExpress.Reporting.Designer.Bands.Metadata {
    ...
    export const detailLevel: DevExpress.Analytics.Utils.ISerializationInfo;
    export const groupLevel: DevExpress.Analytics.Utils.ISerializationInfo;
    export const levelUI: DevExpress.Analytics.Utils.ISerializationInfo;
...
declare module DevExpress.Reporting.Designer.Bands.Internal {
    ...
    import GroupBandViewModel = DevExpress.Reporting.Designer.Bands.GroupBandViewModel;
    import SortableBandViewModel = DevExpress.Reporting.Designer.Bands.SortableBandViewModel;
    import ReportViewModel = DevExpress.Reporting.Designer.Controls.ReportViewModel;
    ...
    export const NEW_GROUPBAND_DEFAULT_LEVEL: any;
    export const NEW_DETAILBAND_DEFAULT_LEVEL: any;
    export const REMOVED_DETAILBAND_LEVEL: number;
    export function getFirstEmptyLevel(bands: DevExpress.Reporting.Designer.Bands.GroupBandViewModel[]): number;
    export function getMaxLevel<T extends {
        level: () => number;
    }>(parentBands: T[] | null): number;
    export function isFirstInit(band: DevExpress.Reporting.Designer.Bands.BandViewModel): boolean;
    export function isBandInserting(band: DevExpress.Reporting.Designer.Bands.BandViewModel): boolean;
    export function levelSetup<T extends DevExpress.Reporting.Designer.Bands.SortableBandViewModel>(band: T, newValue: number): void;
    export function getExistedSameLevelBand<T extends DevExpress.Reporting.Designer.Bands.SortableBandViewModel>(bands: T[], level: number): T;
    export function coerceNewLevelValueOnReordering(value: number, minValue: number, maxValue: number): number;
    export function coerceNewLevelValueOnInserting(value: number, minValue: number, maxValue: number): number;
    export function changeLevels<T extends DevExpress.Reporting.Designer.Bands.SortableBandViewModel>(bands: T[], startIndex: number, endIndex: number): void;
...
declare module DevExpress.Reporting.Designer {
    ...
    import AIExpressionGenerator = DevExpress.Analytics.Widgets.AIExpressionGenerator;
    import ParameterHelper = DevExpress.Reporting.Viewer.Parameters.ParameterHelper;
    import GroupLayoutItem = DevExpress.Reporting.Designer.Data.GroupLayoutItem;
    import IParameterContainer = DevExpress.Reporting.Designer.Data.IParameterContainer;
    import ParameterPanelLayoutItem = DevExpress.Reporting.Designer.Data.ParameterPanelLayoutItem;
    ...
    export class ReportStorageWeb {
        ...
        static getData(url: string): DevExpress.Analytics.Internal.DxPromise<any>;
        static setData(layout: string, url: string): DevExpress.Analytics.Internal.DxPromise<any>;
        static setNewData(layout: string, url: string): DevExpress.Analytics.Internal.DxPromise<any>;
        static getUrls(subreports?: any): DevExpress.Analytics.Internal.DxPromise<any>;
    }
    export interface IReportDesignerRootContext extends IDesignerModel {
        ...
        aiExpressionGenerator: DevExpress.Analytics.Widgets.AIExpressionGenerator;
    }
    ...
    export class JSReportDesigner {
        ...
        ReportStorageGetData(url: string): DevExpress.Analytics.Internal.DxPromise<any>;
        ReportStorageSetData(reportLayout: string, url: string): DevExpress.Analytics.Internal.DxPromise<any>;
        ReportStorageSetNewData(reportLayout: string, url: string): DevExpress.Analytics.Internal.DxPromise<any>;
        ...
        AdjustControlCore(): void;
        SaveNewReport(reportName: string): DevExpress.Analytics.Internal.DxPromise<any>;
...
declare module DevExpress.Reporting.Designer.Utils {
    ...
    export interface IDataSourceRefInfo {
        ...
        isFilterableDataSource?: boolean;
        isJsonDataSource?: boolean;
        isMongoDBDataSource?: boolean;
    ...
    export interface IWizardConnections {
        ...
        mongodb?: DevExpress.Analytics.Wizard.IConnectionStringDefinition[];
    }
    export interface IReportDesignerErrorPanelSettings {
        ...
        showAccessibilityCategory?: boolean;
    ...
    export interface IFakeDataSourceGenerationSettings {
        enableTestDataSourceGeneration?: boolean;
    }
    export interface IAISettings {
        enableLocalization?: boolean;
        enableExpressionGeneration?: boolean;
        reportGenerationSettings?: IAIReportGenerationSettings;
        testDataSourceSettings?: IFakeDataSourceGenerationSettings;
        previewAISettings?: DevExpress.Reporting.Viewer.Utils.IPreviewAISettings;
    }
    export interface IAIReportGenerationSettings {
        enableReportGenerationViaWizard?: boolean;
        predefinedReportPrompts?: IAIReportWizardPromt[];
    }
    export interface IAIReportWizardPromt {
        text: string;
        title: string;
    }
    ...
    export const availableFonts: Observable<{
        [key: string]: string;
    }>;
    export function addPropertyToGroup(groupName: any, property: any): void;
...
declare module DevExpress.Reporting.Designer.Wizard {
    ...
    import IAIReportGenerationSettings = DevExpress.Reporting.Designer.Utils.IAIReportGenerationSettings;
    import IReportWizardSettings = DevExpress.Reporting.Designer.Utils.IReportWizardSettings;
    ...
    import ReportViewModel = DevExpress.Reporting.Designer.Controls.ReportViewModel;
    import ISelectReportTypePageOptions = DevExpress.Reporting.Designer.Wizard.ISelectReportTypePageOptions;
    import SelectReportTypePage = DevExpress.Reporting.Designer.Wizard.SelectReportTypePage;
    import dxListProperties = DevExpress.ui.dxList.dxListProperties;
    import dxTextAreaProperties = DevExpress.ui.dxTextArea.dxTextAreaProperties;
    import dxLoadingPanelProperties = DevExpress.ui.dxLoadPanel.dxLoadingPanelProperties;
    import IAIReportWizardPromt = DevExpress.Reporting.Designer.Utils.IAIReportWizardPromt;
    import AnalyticSpecifyMongoDBDataSourceSettingsPage = DevExpress.Analytics.Wizard.AnalyticSpecifyMongoDBDataSourceSettingsPage;
    import IDataSourceInfo = DevExpress.Analytics.Internal.IDataSourceInfo;
    ...
    export class _ReportWizardOptions extends _DataSourceWizardOptionsBase<DevExpress.Reporting.Designer.Internal.IReportWizardCallbacks> {
        ...
        aiReportGenerationSettings: DevExpress.Reporting.Designer.Utils.IAIReportGenerationSettings;
    ...
    /// <reference types="jquery" />
    export interface ISelectReportTypePageOptions {
    ...
    export class SelectReportTypePage extends AnalyticChooseDataSourceTypePage {
        ...
        constructor(_options: DevExpress.Reporting.Designer.Wizard.ISelectReportTypePageOptions);
    ...
    export function _registerSelectReportTypePage(factory: DevExpress.Analytics.Wizard.FullscreenWizardPageFactory, options: DevExpress.Reporting.Designer.Wizard.ISelectReportTypePageOptions): void;
    ...
    export class ConfigureReportPageSettingsPage extends WizardPageBase {
        ...
        reportUnit: ko.Computed<DevExpress.Reporting.Designer.Wizard.ReportUnit>;
        width: ko.Observable<number>;
        height: ko.Observable<number>;
        ...
        lookupData: {
            ...
            reportUnit: {
                value: DevExpress.Reporting.Designer.Wizard.ReportUnit;
                displayName: string;
            }[];
        };
        private _reportUnit;
    ...
    export function _registerAISelectDataSourceOptionPage(factory: DevExpress.Analytics.Wizard.FullscreenWizardPageFactory, options: DevExpress.Reporting.Designer.Wizard.ISelectReportTypePageOptions): void;
    /// <reference types="jquery" />
    interface IAIEnterReportPromptPageOptions {
        fieldListCallBack: DevExpress.Reporting.Designer.Internal.IReportWizardFieldsCallback;
        predefinedReportPrompts: DevExpress.Reporting.Designer.Utils.IAIReportWizardPromt[];
    }
    export class AIEnterReportPromptPage extends FullscreenWizardPage {
        ...
        canFinish(): boolean;
        commit(): JQuery.Promise<any, any, any>;
        _getSuggentionListOptions(): DevExpress.ui.dxList.dxListProperties;
        _customLoadPanelViewModel(element: any, isLoading: any): DevExpress.ui.dxLoadPanel.dxLoadingPanelProperties;
        _getPromptTextAreaOptions(): DevExpress.ui.dxTextArea.dxTextAreaProperties;
    ...
    export function _registerAIEnterReportPromptPage(factory: DevExpress.Analytics.Wizard.FullscreenWizardPageFactory, options: DevExpress.Reporting.Designer.Wizard._ReportWizardOptions): void;
    export {};
    /// <reference types="jquery" />
    ...
    export function _registerSpecifyMongoDBDataSourceSettingsPage(factory: DevExpress.Analytics.Wizard.FullscreenWizardPageFactory, wizardOptions: DevExpress.Reporting.Designer.Wizard._ReportWizardOptions): void;
...
declare module DevExpress.Reporting.Designer.Localization {
    ...
    class TranslationFactory {
        ...
        getService(name: string): ITranslationService;
        getTranslations(texts: string[], destinationLanguage: string): DevExpress.Analytics.Internal.DxDeferred<ITranslationResult[]>;
        translate(name: string, texts: string[], destinationLanguage: string, destinationLanguageText?: string): DevExpress.Analytics.Internal.DxPromise<ITranslationResult>;
    ...
    export function _unregisterAITranslationService(): void;
    export function _registerAITranslationService(): void;
...
declare module DevExpress.Reporting.Designer.Controls.CrossTab {
    ...
    interface IDefinitionFinder {
        cell: DevExpress.Reporting.Designer.Controls.CrossTab.ICrossTabCell;
        definition: CrossTabDefinitionsModel;
    }
    export class DefinitionUpdater extends Disposable {
        private _columnDefinitions;
        private _rowDefinitions;
        private _serializer;
        constructor(crossTab: DevExpress.Reporting.Designer.Controls.XRCrossTabViewModel);
        findDefinition(array: IDefinitionFinder[], cell: any): IDefinitionFinder;
...
declare module DevExpress.Reporting.Viewer.Mobile.Internal {
    ...
    import HiddenEvent = DevExpress.ui.dxPopup.HiddenEvent;
    import ButtonStyle = DevExpress.ui.dxButton.ButtonStyle;
    import IDateRangeEditorViewModel = DevExpress.Reporting.Viewer.Widgets.IDateRangeEditorViewModel;
    import IDateRangeEditorItem = DevExpress.Reporting.Viewer.Widgets.IDateRangeEditorItem;
    ...
    export interface IDateRangePopupButton {
        text: string;
        focused: boolean;
        stylingMode: DevExpress.ui.dxButton.ButtonStyle;
    ...
    export class ParametersPopupModelBase extends BaseRenderingModel<DevExpress.Reporting.Viewer.Mobile.Internal.IParametersPopupViewModelBase> {
        ...
        _submit: (params: DevExpress.ui.dxButton.ClickEvent) => void;
        _reset: () => void;
        _cancel: () => void;
