/**
* DevExpress HTML/JS Reporting (dx-viewer-templates.generated.js)
* Version:  25.2.4
...
SvgTemplatesEngine.addTemplates({
    ...
    'dxrv-preview-time-range-mobile': '<div class="dxrv-preview-date-range-mobile"> <div class="dx-fieldset"> <div class="dx-field"> <div data-bind="dxSelectBox: { dataSource: items, displayExpr: \'displayName\', onValueChanged: popupModel.onTextChanged, useItemTextAsTitle: true , placeholder: popupModel.selectPeriodPlaceholder }"></div> </div> <div class="dx-field"> <div class="dx-fieldset-column"> <div class="dx-fieldset-header" data-bind="text: popupModel.fromText"></div> <div data-bind="dxDateBox: { type: \'time\', value: startRange.value, onValueChanged: startRange.onValueChanged }" class="dx-accessibility-timerange-item dxrv-timerange-picker-input-start"></div> </div> <div class="dx-fieldset-column dx-fieldset-column-right"> <div class="dx-fieldset-header" data-bind="text: popupModel.untilText"></div> <div class="dxd-back-secondary dx-fieldset-column-separator"></div> <div data-bind="dxDateBox: { type: \'time\', value: endRange.value, onValueChanged: endRange.onValueChanged }" class="dx-accessibility-timerange-item dxrv-timerange-picker-input-start"></div> </div> </div> </div> </div>',
    ...
    'dxrv-daterange-editor-popup': '<div role="dialog" aria-modal="true" data-bind="dxPopup: getPopupSettings()"> <div data-bind="dxScrollView: scrollViewOptions"> <div class="dxrv-daterange-editor-popup-container" data-bind="dxMutationObserver: dialogKeyboardHelper" > <div role="listbox" class="dxrv-daterange-editor-list dxrv-daterange-editor-item dxd-border-primary dx-accessibility-daterange-item" data-bind="attr: predefinedDateRanges.attr, dxScrollView: predefinedDateRanges.scrollViewOptions, dxMutationObserver: predefinedDateRanges.accessibilityKeyboardHelper"> <div class="dx-accessibility-container-background dxd-back-accented"></div> <!-- ko foreach: predefinedDateRanges.items --> <div role="option" class="dxrv-daterange-editor-list-item dxd-state-normal dxd-back-highlighted dx-accessibility-list-item dx-accessibility-focus-border-accented" data-bind="attr: { \'aria-selected\': selected }, css: { \'dxd-state-selected\': selected }, dxAction: { action: click }"> <div class="dx-accessibility-field-background dxd-back-accented"></div> <!-- ko text: displayName --> <!-- /ko --> </div> <!-- /ko --> </div> <div class="dxrv-daterange-editor-item"> <div class="dx-accessibility-container-background dxd-back-accented"></div> <!-- ko template: { name: \'dxrv-daterange-calendar\', data: startRange } --> <!-- /ko --> </div> <div class="dxrv-daterange-editor-item"> <div class="dx-accessibility-container-background dxd-back-accented"></div> <!-- ko template: { name: \'dxrv-daterange-calendar\', data: endRange } --> <!-- /ko --> </div> </div> </div>  </div>',
    'dxrv-daterange-editor-timeonly-popup': '<div role="dialog" aria-modal="true" data-bind="dxPopup: getPopupSettings(true)"> <div data-bind="dxMutationObserver: dialogKeyboardHelper" class="dxrv-timerange-editor-popup-content"> <!-- ko foreach: predefinedDateRanges.groupedItems --> <div class="dxrv-timerange-editor-popup-container" data-bind="dxBox: { direction: \'row\', width: \'450px\', height: 25, onItemClick: function(e) { $parent.onRangeItemClick(e); }, onItemRendered: function(e) { $parent.onRangeItemsRendered(e); }, items: $data.map(function(item) { return { ratio: item.ratio, template: item.template, click: item.click, selected: item.selected, id: item.id } }), }" ></div> <!-- /ko --> <div data-bind="dxBox: { direction: \'row\', width: \'450px\', height: 30 }" class="dxrv-timerange-picker-container"> <div data-options="dxItem: { ratio: 1 }"> <div class="dxrv-timerange-editor-popup-picker"> <span data-bind="text: $root.getLocalization(\'Start\', \'PreviewStringId.RangeParameters_Start\')"></span> <div data-bind="dxDateBox: { type: \'time\', value: $parent.startRange.value, onValueChanged: $parent.startRange.onValueChanged, dropDownOptions: { container: $root.getPopupContainer($element) } }" class="dx-accessibility-timerange-item dxrv-timerange-picker-input-start"></div> </div> </div> <div data-options="dxItem: { ratio: 1 }"> <div class="dxrv-timerange-editor-popup-picker"> <span data-bind="text: $root.getLocalization(\'End\', \'PreviewStringId.RangeParameters_End\')"></span> <div data-bind="dxDateBox: { type: \'time\', value: $parent.endRange.value, onValueChanged: $parent.endRange.onValueChanged, dropDownOptions: { container: $root.getPopupContainer($element) } }" class="dx-accessibility-timerange-item dxrv-timerange-picker-input-end"></div> </div> </div> </div> </div>  </div>',
