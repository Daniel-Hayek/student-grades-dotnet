...
import { JsonDataSource, MongoDBDataSource, SqlDataSource } from '@devexpress/analytics-core/analytics-data';
...
export interface IReportWizardCallbacks extends IMultiQueryDataSourceWizardCallbacks {
    ...
    createMongoDBDataSourceInfo?: (dataSource: MongoDBDataSource) => DxPromise<IDataSourceInfo>;
}
export interface IReportWizardFieldsCallback {
    (request: IPathRequest, dataSource: IAnalyticDataSourceInfo, useCache?: boolean): JQueryPromise<IDataMemberInfo[]>;
}
