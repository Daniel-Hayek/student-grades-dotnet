...
import { createDeferred, roundingXDecimals } from '@devexpress/analytics-core/analytics-internal-native';
export class CustomizeLabelPage extends WizardPageBase {
    ...
    _getLabelsCount(paperDimentionInLabelUnit, labelPitch, labelWidth, margin) {
        const value = (paperDimentionInLabelUnit - margin + (labelPitch - labelWidth)) / labelPitch;
        return Math.floor(roundingXDecimals(value, false, 6));
    }
    constructor() {
        super();
