...
export declare class DataSourceWizardHelper<TState = any, TSource = any> {
    private _page;
    private _callback;
    constructor(_page: IWizardPage, _callback: (dataSource: any) => DxPromise<IDataSourceInfo>);
    commit(superCommit: () => DxPromise<TState>, createDataSource: (state: TState) => TSource): JQuery.Promise<any, any, any>;
}
