...
export class ReportDataSourceService {
    ...
    static getWizardMongoDBDataConnections() {
        return sendRequest(HandlerUri(), 'getWizardMongoDBDataConnections', '');
    }
    ...
    static getMongoDBDataSourceBase64(dataSource) {
        return sendRequest(HandlerUri(), 'getMongoDBDataSourceBase64', PrepareRequestArgs({ mongoDBDataSourceJSON: JSON.stringify({ MongoDBDataSource: new ModelSerializer().serialize(dataSource) }) }));
    }
    ...
    static getMongoDBDataSourceFromBase64(base64) {
        return sendRequest(HandlerUri(), 'getMongoDBDataSourceFromBase64', PrepareRequestArgs({ base64: base64 }));
    }
}
