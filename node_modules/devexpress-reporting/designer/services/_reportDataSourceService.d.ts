...
*/
import { FederationDataSource, JsonDataSource, MongoDBDataSource, SqlDataSource, TableQuery } from '@devexpress/analytics-core/analytics-data';
...
export declare class ReportDataSourceService {
    ...
    static getWizardMongoDBDataConnections(): DxPromise<IConnectionStringDefinition[]>;
    ...
    static getMongoDBDataSourceBase64(dataSource: MongoDBDataSource): DxPromise<{
        base64: string;
    }>;
    ...
    static getMongoDBDataSourceFromBase64(base64: string): DxPromise<{
