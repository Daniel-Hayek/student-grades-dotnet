...
function _createReportDesigner(element, data, callbacks, knownEnums, designerHandlerUri, previewHandlerUri, rtl, applyBindings = true) {
    ...
    return initializer
        ...
        aiSettings: data.aiSettings?.previewAISettings,
    })
        ...
        mongodb: ko.observableArray(data.wizardConnections && data.wizardConnections.mongodb)
        ...
        settings.createSqlDataSourceEditor({
            ...
            displayNameProvider: model.displayNameProvider,
            model: model.model,
        ...
        .tryAddCollectionDataSourceFilterEditorAddon()
