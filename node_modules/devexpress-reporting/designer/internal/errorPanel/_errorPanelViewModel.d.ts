...
import { Properties as dxDataGridOptions } from 'devextreme/ui/data_grid';
...
export declare class ErrorPanelViewModel extends Disposable {
    ...
    _dataGridOptions: dxDataGridOptions;
    ...
    getIconTemplateByErrorCategory(rowData: IErrorModel): string;
    getIconTemplateName(errorType: ErrorType): string;
    getTitleByErrorType(errorType: ErrorType): string;
    _getTotalCountByErrorType(errorType: ErrorType): number;
