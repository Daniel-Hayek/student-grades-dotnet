...
export declare class FieldListDragDropHelper {
    ...
    constructor(_dataBindingMode: DataBindingMode, _size?: Size, _performBindings?: boolean);
...
interface IListMemberContol extends IMemberContolBase {
    drop: (treeListItem: ITreeListItemViewModel, dropTargetControl: XRReportElementViewModel, dataBindingMode: DataBindingMode, size?: ISize, performBindings?: boolean) => DxPromise<IElementViewModel>;
}
