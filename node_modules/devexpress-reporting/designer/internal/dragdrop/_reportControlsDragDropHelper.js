...
import { SortableBandViewModel } from '../../bands/sortableBand';
export class ReportControlsDragDropHelper extends ObjectExplorerDragDropHelper {
    ...
    updateLevels(targetModel) {
        if (this._draggableModel.constructor === targetModel.constructor && targetModel instanceof SortableBandViewModel) {
