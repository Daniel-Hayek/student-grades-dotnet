...
export class SummaryEditorModel extends Disposable {
    ...
    constructor(_control) {
        ...
        this._disposables.push(this.calculate = new WrappedExpressionOptions({ value: ko.observable(''), control: _control }));
        this._disposables.push(this.weight = new WrappedExpressionOptions({ value: ko.observable(''), control: _control }));
