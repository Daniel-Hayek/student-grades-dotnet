...
import { drillDownControl, drillDownDetailReportExpanded, height, keepTogetherWithDetailReports, pageBreak, printAcrossBands, printAtBottom, repeatEveryPage, levelUI } from '../bands/metadata/bandsMetadata';
...
export const groups = {
    ...
    'Appearance': {
        info: [
            ...
            lineDirection, lineStyle, lineSpacing, lineWidth, padding, pageColor,
    ...
    'Behavior': {
        info: [
            ...
            barCodeOrientation, canGrow, canPublishOptions, canShrink, conditionObj,
            ...
            keepTogether, keepTogetherWithDetailReports, levelUI,
    ...
    'Design': {
        info: [name, snapGridSize, snappingMode, drawWatermark, language, designerOptions],
    ...
    'Page Settings': {
        info: [
            landscape, rollPaper, pageWidthF, pageHeightF, paperKind, margins, defaultPrinterSettingsUsingInfo
        ],
