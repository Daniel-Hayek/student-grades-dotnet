...
import { koUtils, validateExpression } from '@devexpress/analytics-core/analytics-internal';
...
export class WrappedExpressionOptions extends Disposable {
    constructor(options, handlers, fieldListProvider, eventName) {
        ...
        this.customizeContext = (context) => {
            context.controlName = koUtils.unwrap(options.control.name);
            context.eventName = this.eventName;
            context.propertyName = options.propertyName;
        };
    }
    onHiding(e) { }
    onShowing(e) { }
