...
export declare class ObjectStorageItem extends ObjectItem {
    ...
    constructor(model: any, dsHelperProvider?: any, serializer?: IModelSerializer, objectType?: string);
    isEmpty(): boolean;
...
export declare class _DxObjectStorageItem extends ObjectStorageItem {
