...
import { _DxObjectStorageItem, ObjectStorageItem } from './objectStorageItem';
...
export class ObjectsStorage extends Disposable {
    ...
    getType(type) {
        ...
        if (!typeObject) {
            typeObject = new _DxObjectStorageItem({
                '@Content': type,
                '@Type': 'System.Type',
    ...
    addValue() {
        const newValueRef = new _DxObjectStorageItem({ '@Content': '' }, this.dsHelperProvider);
