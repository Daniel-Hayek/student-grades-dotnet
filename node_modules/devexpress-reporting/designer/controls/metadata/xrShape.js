...
import { angle, defaultDecorativeAccessibleRole, foreColor, lineStyle, lineWidth } from './properties/metadata';
...
].concat(sizeLocation, commonControlProperties, navigationGroup, defaultDecorativeAccessibleRole);
