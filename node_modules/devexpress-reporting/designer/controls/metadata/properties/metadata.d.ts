...
export declare const lineSpacing: ISerializationInfo;
...
export declare const collectionDataSourceCriteria: {
    propertyName: string;
    modelName: string;
    displayName: string;
    localizationId: string;
...
export declare const xafPropertiesInfo: ISerializationInfo[];
...
export declare const canPublishOptions: ISerializationInfo;
...
export declare const decorativeAccessibleRole: {
    value: string;
    displayValue: string;
    localizationId: string;
};
export declare const paragraphAccessibleRole: {
    value: string;
    displayValue: string;
    localizationId: string;
};
export declare const figureAccessibleRole: {
    value: string;
    displayValue: string;
    localizationId: string;
};
...
export declare const defaultDecorativeAccessibleRole: any;
