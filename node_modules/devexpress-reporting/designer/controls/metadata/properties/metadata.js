...
export const lineSpacing = { propertyName: 'lineSpacing', modelName: '@LineSpacing', displayName: 'Line Spacing', localizationId: 'DevExpress.XtraReports.UI.XRLabel.LineSpacing', defaultVal: 1, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), editorOptions: { min: 0.1 } };
...
export const collectionDataSourceCriteria = { propertyName: 'criteriaString', modelName: '@CriteriaString', displayName: 'Criteria', localizationId: 'ASPxReportsStringId.ReportDesigner_CollectionDataSource_Criteria', defaultVal: '', editor: editorTemplates.getEditor('filterEditor') };
...
export const xafPropertiesInfo = [
    { propertyName: 'topReturnedRecords', modelName: '@TopReturnedRecords' },
    { propertyName: 'objectTypeName', modelName: '@ObjectTypeName' },
    {
        ...
        info: [
            {
                ...
                info: [
                    ...
                    { propertyName: 'direction', modelName: '@Direction' },
                ],
            },
        ],
    },
...
export const canPublishOptions = { propertyName: 'canPublishOptions', modelName: '@CanPublishOptions', defaultVal: 'All',
    displayName: 'Can Publish Options', localizationId: 'DevExpress.XtraReports.UI.XRControl.CanPublishOptions',
    descriptionLocalizationId: 'DevExpress.XtraReports.UI.XRControl.CanPublishOptions.Description', editor: designerEditorTemplates.getEditor('canPublishEditor'),
    valuesArray: [
        { value: 'Csv', displayValue: 'Csv', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Csv' },
        { value: 'Docx', displayValue: 'Docx', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Docx' },
        { value: 'Htm', displayValue: 'Htm', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Htm' },
        { value: 'Image', displayValue: 'Images', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Image' },
        { value: 'Mht', displayValue: 'Mht', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Mht' },
        { value: 'Pdf', displayValue: 'Pdf', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Pdf' },
        { value: 'Printing', displayValue: 'Printing', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Printing' },
        { value: 'Rtf', displayValue: 'Rtf', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Rtf' },
        { value: 'Txt', displayValue: 'Txt', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Txt' },
        { value: 'Xls', displayValue: 'Xls', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Xls' },
        { value: 'Xlsx', displayValue: 'Xlsx', localizationId: 'DevExpress.XtraReports.UI.CanPublishOptions.Xlsx' },
    ]
};
...
export const decorativeAccessibleRole = { value: 'Decorative', displayValue: 'Decorative', localizationId: 'DevExpress.XtraReports.UI.XRAccessibleRole.Decorative' };
export const paragraphAccessibleRole = { value: 'Paragraph', displayValue: 'Paragraph', localizationId: 'DevExpress.XtraReports.UI.XRAccessibleRole.Paragraph' };
export const figureAccessibleRole = { value: 'Figure', displayValue: 'Figure', localizationId: 'DevExpress.XtraReports.UI.XRAccessibleRole.Figure' };
...
export const defaultDecorativeAccessibleRole = extend({}, accessibleRole, { valuesArray: [
        defaultAccessibleRole,
        decorativeAccessibleRole
    ] });
