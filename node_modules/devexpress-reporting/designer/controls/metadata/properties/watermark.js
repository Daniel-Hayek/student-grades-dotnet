...
import { defaultAccessibleRole, figureAccessibleRole, font, foreColor, paragraphAccessibleRole } from './metadata';
...
export const textAccessibleRole = {
    propertyName: 'accessibleRole',
    modelName: '@AccessibleRole',
    displayName: 'Role',
    localizationId: 'ASPxReportsStringId.ReportDesigner_Watermarks_AccessibleRole',
    descriptionLocalizationId: 'DevExpress.XtraReports.UI.XRWatermark.AccessibleText.Role',
    defaultVal: 'Default',
    editor: editorTemplates.getEditor('combobox'),
    valuesArray: [defaultAccessibleRole, paragraphAccessibleRole]
};
export const imageAccessibleRole = {
    propertyName: 'accessibleRole',
    modelName: '@AccessibleRole',
    displayName: 'Role',
    localizationId: 'ASPxReportsStringId.ReportDesigner_Watermarks_AccessibleRole',
    descriptionLocalizationId: 'DevExpress.XtraReports.UI.XRWatermark.AccessibleImage.Role',
    defaultVal: 'Default',
    editor: editorTemplates.getEditor('combobox'),
    valuesArray: [defaultAccessibleRole, figureAccessibleRole]
};
const wmAccessibleDescription = {
    propertyName: 'accessibleDescription',
    displayName: 'Description',
    localizationId: 'ASPxReportsStringId.ReportDesigner_Watermarks_AccessibleDescription',
    localizable: true,
    modelName: '@AccessibleDescription',
    editor: editorTemplates.getEditor('text')
};
export const wmTextAccessibleDescription = extend({}, wmAccessibleDescription, {
    descriptionLocalizationId: 'DevExpress.XtraReports.UI.XRWatermark.AccessibleText.Description'
});
export const wmImageAccessibleDescription = extend({}, wmAccessibleDescription, {
    descriptionLocalizationId: 'DevExpress.XtraReports.UI.XRWatermark.AccessibleImage.Description'
});
