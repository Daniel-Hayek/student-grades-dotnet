...
import { accessibleDescription, canPublishOptions, location, rtl, text, textAlignment } from './properties/metadata';
...
const tocProperties = commonControlProperties.filter((item) => { return item !== canPublishOptions && item != accessibleDescription; });
