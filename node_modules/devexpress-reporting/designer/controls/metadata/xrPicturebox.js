...
import { defaultDecorativeAccessibleRole, keepTogether } from './properties/metadata';
...
export const pictureBoxSerializationsInfo = [
    ...
    imageEditOptions
].concat(createPopularBindingInfos({ propertyName: 'ImageUrl', localizationId: 'DevExpress.XtraReports.UI.XRPictureBox.ImageUrl' }), createPopularBindingInfos({ propertyName: 'ImageSource', localizationId: 'DevExpress.XtraReports.UI.XRPictureBox.ImageSource' }), sizeLocation, commonControlProperties, navigationGroup, processGroup, defaultDecorativeAccessibleRole);
