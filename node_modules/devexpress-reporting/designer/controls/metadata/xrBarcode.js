...
import { defaultDecorativeAccessibleRole, keepTogether, text, textAlignment, textAlignmentValues, textFormatString } from './properties/metadata';
...
].concat(createSinglePopularBindingInfos('Text'), sizeLocation, commonControlProperties, defaultDecorativeAccessibleRole, fontGroup, navigationGroup, processGroup);
