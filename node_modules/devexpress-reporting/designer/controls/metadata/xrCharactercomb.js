...
import { accessibleRole, autoWidth, backColor, borderColor, borderDashStyle, borderDashStyleValues, borderWidth, canPublishOptions, foreColor, keepTogetherDefaultValueFalse, multiline, nullValueText, rtl, summary, text, textAlignment, textArea, textFormatString, xlsxFormatString } from './properties/metadata';
...
export const characterCombSerializationsInfo = [
    accessibleRole, styleName, evenStyleName, oddStyleName, stylePriority, canPublishOptions, backColor, autoWidth, action,
