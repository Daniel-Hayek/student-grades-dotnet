...
import { defaultDecorativeAccessibleRole, foreColor, keepTogether, text, textFormatString } from './properties/metadata';
...
].concat(createSinglePopularBindingInfos('Text'), sizeLocation, commonControlProperties, navigationGroup, defaultDecorativeAccessibleRole);
