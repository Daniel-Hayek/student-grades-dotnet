...
export declare const snappingMode: ISerializationInfo;
...
export declare const pageWidthF: ISerializationInfo;
export declare const pageHeightF: ISerializationInfo;
