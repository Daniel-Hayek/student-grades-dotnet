...
export class ControlsFactory extends AnalyticControlsFactory {
    ...
    _registerExtensions(controlType, metadata) {
        ...
        switch (parentType) {
            ...
            case 'VerticalHeaderBand':
            case 'VerticalDetailBand':
            case 'VerticalTotalBand':
            case 'PageFooterBand':
    ...
    _createExpressionObject(control, expressions, path, summaryRunning) {
        return this._expressionWrapper.createExpressionsObject(control, expressions, path, summaryRunning);
    }
