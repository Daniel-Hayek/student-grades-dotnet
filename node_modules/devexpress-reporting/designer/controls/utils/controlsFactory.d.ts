...
export declare class ControlsFactory extends AnalyticControlsFactory<ControlType> implements IDisposable {
    ...
    _createExpressionObject(control: XRReportElementViewModel, expressions: ko.ObservableArray<IExpressionBinding>, path?: ko.Computed<string>, summaryRunning?: (name: string) => ko.Observable<boolean> | ko.Computed<boolean>): IExpressionObject;
