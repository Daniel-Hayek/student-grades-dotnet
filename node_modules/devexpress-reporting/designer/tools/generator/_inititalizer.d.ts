...
import { IAISettings, ICultureInfoList, ICustomControlTypeInfo, ICustomExpressionInfo, IReportDesignerCustomizationHandler, IReportDesignerErrorPanelSettings, IReportDesignerParameterEditingSettings, IReportWizardSettings } from '../../utils/inititalizer';
...
export declare class ReportDesignerInitializer extends CommonDesignerGenerator<IReportDesignerRootContext> {
    ...
    addAIFeatures(aiSettings: IAISettings): ReportDesignerInitializer;
