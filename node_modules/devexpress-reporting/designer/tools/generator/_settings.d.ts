...
import { IExportSettings, IPreviewAISettings, IPreviewCustomizationHandler, IProgressBarSettings, ISearchSettings } from '../../../viewer/utils/initializer';
...
import { IAISettings, IReportDesignerCustomizationHandler, IReportDesignerInitializationData, IReportWizardSettings } from '../../utils/inititalizer';
...
export declare class WizardsInitializerSettings {
    ...
    mongoDBDataSourceEditor: MongoDBDataSourceEditor;
    ...
    createSqlDataSourceEditor(settings: {
        ...
        displayNameProvider: ko.Observable<DisplayNameProvider> | ko.Computed<DisplayNameProvider>;
        rtl: boolean;
