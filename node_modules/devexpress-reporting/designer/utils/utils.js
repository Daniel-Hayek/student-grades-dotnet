...
export function addPropertyToGroup(groupName, property) {
    if (groups[groupName] === undefined) {
        ...
        if (groups[groupName].info.some((existingProperty) => existingProperty.propertyName === property.propertyName)) {
            return;
        }
        groups[groupName].info.push(property);
    }
}
