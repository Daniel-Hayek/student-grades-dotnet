...
import { drillDownControl, drillDownDetailReportExpanded, groupLevel, levelUI, pageBreak, printAcrossBands, printAtBottom, repeatEveryPage } from './bandsMetadata';
...
const groupBand = [keepTogetherDefaultValueFalse, groupLevel, levelUI, pageBreak, repeatEveryPage].concat(bandSerializationInfo);
...
export const popularPropertiesGroupFooter = ['groupFooterUnion', 'pageBreak', 'keepTogether', 'repeatEveryPage', 'printAtBottom', 'level'];
