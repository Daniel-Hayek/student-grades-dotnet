...
export const detailLevel = { propertyName: '_level', modelName: '@Level', defaultVal: -1, from: floatFromModel };
export const groupLevel = { propertyName: '_level', modelName: '@Level', defaultVal: 0, from: floatFromModel };
export const levelUI = { propertyName: 'level', displayName: 'Level', localizationId: 'DevExpress.XtraReports.UI.GroupBand.Level', editor: designerEditorTemplates.getEditor('bandLevel') };
